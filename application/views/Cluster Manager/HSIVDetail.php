          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>School Installation Visit Detail</h5><hr>
                       <div class="row">
                       <?php $data = $this->Menu_model->get_htprodetail($cid,'43',$tid,$sid); $i=1; foreach($data as $da){?>
                       <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                       
                       
                       <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                           Task Name<br><b><?=$da->que?></b><hr>
                           Task date<br><b><?php if($da->sdatet){echo $this->Menu_model->get_dformat($da->sdatet);}else{echo 'NO DATA';}?></b><hr>
                           ...
                           <?php if($da->ans1){?>
                           <img class="img-thumbnail" src="https://stemoppapp.in/<?=$da->ans1?>" width="100%">
                           <?php } if($da->ans2){?>
                           <video class="embed-responsive-item img-thumbnail" src="https://stemoppapp.in/<?=$da->ans2?>" height="300" muted controls></video>
                           <?php } ?>
                           <hr>
                           <b><?=$da->lat?></b><hr>
                           <b><?=$da->lon?></b><hr>
