            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                with font-awesome or any other icon font library -->
                 ...
                 <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?=base_url();?>Menu/BDAssignRequestBYInsidesSales" class="nav-link">
                            <i class="nav-icon fas fa-tasks"></i>
                            <p>BD Assign Request BY Insides Sales</p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?=base_url();?>Menu/OurTravelAdvanceRequest" class="nav-link">
                                ...
                                <p>Our Cash Advance Request</p>
                            </a>
                            </li>
                            <li class="nav-item">
                            <a href="<?=base_url();?>Menu/OurCashExpenseReport" class="nav-link">
                                <i class="fa-solid fa-hand-point-right"></i>
                                <p>Our Cash Expense Request</p>
                            </a>
                            </li>
                            <li class="nav-item">
...
<?php 
      ...
      ?>
       <?php // $this->Menu_model->CheckUserPlannerStartOrNot($current_uid,date("Y-m-d")); ?>
      ...
      $.ajax({
          ...
          success: function (result) {
            ...
            if(results > 0){
              ...
              let rediectDashboard2 = "https://stemapp.in/Menu/Dashboard2";
            ...
            //   }
              ...
              if (currentLocation !== redirectreviewpage &&
                    currentLocation !== redirectDayManagement &&
                    currentLocation !== rediectDashboard2) {
