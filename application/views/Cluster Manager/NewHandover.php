      ...
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
             <div class="row">
                 ...
                 foreach($mdata as $dt){ $pid=$dt->id; $cdate=date('Y-m-d H:i:s');
                 $pcode = $dt->projectcode;
                 $joincall = $this->Menu_model->get_joincallpcode($pcode);
                 ?>
                 <div class="col-lg-3 col-md-6 col-sm p-3 bg-info rounded border">
                     <a href="<?=base_url();?>Menu/SchoolBOX/<?=$pid?>">
                     ...
                     Installation Timeline<br><b><?=$insrd=$joincall[0]->insrd?></b><hr>
                     Time Diffrence<br><b><?=$this->Menu_model->timediff($insrd,$cdate);?></b><hr>
                     </a>
                 </div>
                 <?php } ?>
              </div>
