            ...
            <div class="small-box bg-light text-secondary">
              <div class="inner">
                ...
                <div class="collapse" id="collapse2">
                    <a href="ATaskDetail/3/<?=$uid?>/1/<?=$tdate?>/<?=$tdate?>/0"><p>Call Done- <b><?=$tttd->e?></b></a>
                    <a href="ATaskDetail/3/<?=$uid?>/2/<?=$tdate?>/<?=$tdate?>/0"><p>Email Done- <b><?=$tttd->f-$tttd->g?></b></p></a><hr>
                    <a href="ATaskDetail/3/<?=$uid?>/3/<?=$tdate?>/<?=$tdate?>/0"><p>Sheduled Meeting Done- <b><?$tttd->i?></b></p></a><hr>
                    <a href="ATaskDetail/3/<?=$uid?>/4/<?=$tdate?>/<?=$tdate?>/0"><p>Barg in Done- <b><?=-$tttd->k?></b></p></a><hr>
                    <a href="ATaskDetail/3/<?=$uid?>/5/<?=$tdate?>/<?=$tdate?>/0"><p>Whatsapp Done- <b><?=$tttd->m?></b></p></a><hr>
                    <a href="ATaskDetail/3/<?=$uid?>/6/<?=$tdate?>/<?=$tdate?>/0"><p>MOM Done- <b><?=$tttd->o?></b></p></a><hr>
                    <a href="ATaskDetail/3/<?=$uid?>/7/<?=$tdate?>/<?=$tdate?>/0"><p>Proposal Done- <b><?=$tttd->q?></b></p></a><hr>
...
<div class="small-box bg-light text-secondary">
    ...
    <a href="TBMDetail" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      ...
      <?php
        $cont=0;$pass=0;$tass=0;$ini=0;$pend=0;$close=0;
	$cmbddata = $this->Menu_model->getClusterWithteam($uid);

        foreach ($cmbddata as $b){
	$bdid = $b->user_id;
        ...
        ?>
                ...
                <a href="ProgramDetail"><p>Total Handover</a></pr><hr>
                ...
                <a href="TBDRequest/1">Total Request - <b><?=$cont;?></b></a><hr>
                    <a href="#">Total Request Initiated - <b>0</b></p></a><hr>
                    <a href="TotalBDRequestinPST/5">Total Request Completed - <b><?= $close; ?></b></p></a><hr>
                    <a href="TotalBDRequestinPST/7">Total Request Pending - <b><?= $pend; ?></b></p></a><hr>
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-research-tab" data-toggle="pill" href="#custom-tabs-four-research" role="tab" aria-controls="custom-tabs-four-research" aria-selected="false">
                       Research <span class="badge badge-success"><?=$ttbyd[0]->j?></span>
                    </a>
                  </li>
                <!--  <li class="nav-item">
              ...
              <?php /*
                 ...
                 */ ?>                       
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-bdrequest" role="tabpanel" aria-labelledby="custom-tabs-four-bdrequest-tab">
                      ...
                      foreach($totalt as $tt){if($tt->plan==1){
                        if($tt->actiontype_id=='19' || $tt->actiontype_id=='20' || $tt->actiontype_id=='21' || $tt->actiontype_id=='22'){
                          ...
                          if($remarks == 'Create BD Request'){
                            ...
                            $bdrmessage     = '';
                          }elseif($remarks == "Praposal Check" || $remarks == 'Proposal Check'){
...
<?php } ?>
 ...
 if($tt->autotask == 1){$style = 'background: antiquewhite;'; $titletask = 'Auto Task';}else{$style =''; $titletask='';}
				$time = $tt->appointmentdatetime;
                      ...
                      ?>
                        <a href="CompanyDetails/<?=$tt->cid?>/?tid=<?=$tt->id?>"><div class="list-group-item list-group-item-action" title="<?=$titletask ?>" style="<?= $style ?>">
                           <span class="mr-3 align-items-center">
                              <i class="fa-solid fa-circle"></i>
                           </span>
                           <span class="flex">
