                                    ...
                                    <div class="pdf-viwer">
                                        <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                           ...
                                           */
                                                    ...
                                                    $company_master_id = $taskdata->company_master_id;
                                                    $main_bdname = $taskdata->bdname;
                                                ...
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><a href="<?=base_url()?>Menu/CompanyDetails/<?= $taskdata->company_master_id ?>" target='_blank'><?= $taskdata->compname ?></a></td>
                                                    <td><a href="<?=base_url()?>Menu/CompanyDetails/<?= $taskdata->company_master_id ?>" target='_blank'><?= $taskdata->company_master_id ?></a></td>
                                                    <td><?= $taid[0]->name ?></td>
