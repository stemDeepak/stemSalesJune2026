      ...
      <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <?php
            ...
            if(in_array($user['type_id'], [13])){
              // $nine_hours_planning = 420; // 9 hours Planning = 9* 60 = 540 Minutes 
            }
...
$plandate = date("Y-m-d");
                      ...
                      // $nextFollowUpDataCnt  = 0;
                       ...
                       $days = 8;
                        if($type_id ==3){
                         ...
                         $dyslimit = 15;
                        }else if($type_id ==13 || $type_id ==4 || $type_id ==22){
   ...
   <div id="bargmeetingcluster" class="form-group">
                    ...
                    <div class="form-group" id="taskActionbyuserCard">
                      <label>Select Previous Task Action Taken</label>
