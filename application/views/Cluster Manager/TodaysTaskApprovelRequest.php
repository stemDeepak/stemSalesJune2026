                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div>
                                      <p><a href="<?=base_url();?>Menu/TodaysTaskapprove/<?= $data->nrid?>/Approve" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                                      <p><button type="button" class="btn btn-primary"  onclick="Reject(<?= $j ?>,<?= $data->nrid?>,'Reject')">Reject</button></p>
                                    </div>
