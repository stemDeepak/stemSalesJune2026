                  ...
                  <form action="<?=base_url();?>Menu/checkmeeting" method="post">
                    ...
                    <div class="form-group">
                        ...
                        foreach ($mdata as $md){ 
                            ...
                            $diff = $this->Menu_model->timediff($startm,$closem);
                        ?>
                            ...
                            <div class="text-center"><h5>Total Time Difference @<?=$diff?></h5></div>
                            <hr>
                            ...
                            <textarea class="form-control" name="mremark" placeholder="Remark" required=""></textarea>
