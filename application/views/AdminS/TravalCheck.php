       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <h3 class="text-center">Check Meeting</h3>
                  <hr>
                  <form action="<?=base_url();?>Menu/checkmeeting" method="post">
                     <input type="hidden" name="udid" value="<?=$mdata[0]->tid?>">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                            <div class="text-center"><h5><?=$md->name?></h5></div>
                            <div class="text-center"><h5>Traval Start @</h5></div>
                            <div class="text-center"><h5>Traval End @</h5></div>
                            <div class="text-center"><h5>Total Meeting</h5></div>
                            <div class="text-center"><h5>Total Schedule Meeting</h5></div>
                            <div class="text-center"><h5>Total Bargin Meeting</h5></div>
                            <div class="text-center"><h5>Total RP</h5></div>
                            <div class="text-center"><h5>Total Expense Request</h5></div>
                            <div class="text-center"><h5>Per Meeting Cost</h5></div>
                            <div class="text-center"><h5>Per RP Meeting Cost</h5></div>
                            <hr>
                            
                            <div class="text-center"><h5><?=$md->company_name?></h5></div>
                            <div class="text-center"><h5>Metting Started @<?=$startm?></h5></div>
                            <div class="text-center"><h5>Metting Closed @<?=$closem?></h5></div>
                            <hr>
                            <div class="text-center"><h5>MOM</h5><b><?php if($momc){echo $momc[0]->mom;}else{$momc='no';}?></b></div>
                            <hr>
                            <div class="text-center"><h5>Email</h5><b><?php if($emailc){$emailc='yes';}else{$emailc='no';}?></b></div>
                            <hr>
                            <div class="text-center"><h5>PST Assign</h5><b><?php if($psta){$psta='yes';}else{$psta='no';}?></b></div>
                            <hr>
                            
                            <br>
                            <div class="text-center"><img src="<?=base_url();?><?=$md->cphoto?>" class="img-thumbnail" width="50%"></div>
                            <br>
                            ...
                            <div class="from-group">
                                <h5 class="text-center"><input type="hidden" name="que[]" value="Meeting Started at Good Time">Meeting Started at Good Time</h5>
                                <div class="rating">
                            ...
                            <div class="from-group">
                                <h5 class="text-center"><input type="hidden" name="que[]" value="Meeting Closed at Good Time">Meeting Closed at Good Time</h5>
                                <div class="rating">
                            ...
                            <div class="from-group">
                                <h5 class="text-center"><input type="hidden" name="que[]" value="Company Image is Good">Company Image is Good</h5>
                                <div class="rating">
                            ...
                            <div class="from-group">
                                <h5 class="text-center"><input type="hidden" name="que[]" value="MoM is Good">MoM is Good</h5>
                                <div class="rating">
