...
<div class="container-fluid p-3">
    <form action="<?=base_url();?>Menu/rpmeetreport" method="POST" >
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="text-center m-3 text-secondary">RP Meeting Report</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                                    ...
                                    <tbody>
                                      <?php 
                                        for($i = $sdate; $i <= $edate; $i->modify('+1 day')){
                                            $date = $i->format("Y-m-d");
                                        $mdata=$this->Menu_model->get_rpmreport($date);
                                        foreach($mdata as $dt){
                                        ?>
                                    <tr>
                                         <td><?=$date?></td>
