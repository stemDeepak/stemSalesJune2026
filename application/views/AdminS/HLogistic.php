          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>Logistic Detail</h5><hr>
                       <div class="row">
                          <?php $i=1;$fpur = $this->Menu_model->get_flogistic($project);
                          foreach($fpur as $pur){
                          ?>
                           ...
                           <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                                <b><?=$i++?></b><hr>
                                School Name<br><b><?=$pur->sname?></b><hr>
                                School Address<br><b><?=$pur->saddress?>, <?=$pur->scity?>, <?=$pur->sstate?></b><hr>
                                Info Date<br><b><?=$pur->sdatet?></b><hr>
                                Contact Person<br><b><?=$pur->cp_name?></b><hr>
                                Mobile No<br><b><?=$pur->cp_mno?></b><hr>
                                Information<br><b><?=$pur->loginfo?></b><hr>
