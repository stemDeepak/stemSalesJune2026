...
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/ReviewReport">
    ...
    <select name="pstname">
        <option value="<?=$myid?>"><?=$user['name']?></option>
    ...
    <select name="bdid">
        ...
        <?php $bd = $this->Menu_model->get_userbyaid($admid);
        foreach($bd as $bd){
        ?>
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tr>
                                        <td><a href="ReviewDetail/<?=$md->rid?>">Review Report</a></td>
                                        <td><a href="AfterReviewDetail/<?=$md->rid?>">Current Scenario</a></td>
                                        <td><?=$i?></td>
                                        <td><?=$nstartt?></td>
                                        <td><?=$ncloset?></td>
