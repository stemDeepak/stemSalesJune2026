...
<div class="col-12">
<div>
<form class="p-3" method="POST" action="PSTDataCData"><input type="date" name="sdate" class="mr-2" value="<?=$sd?>"><input type="date" name="edate" class="mr-2" value="<?=$ed?>">
                            ...
                            <!-- <th>Change Status</th> -->
                                ...
                                <!-- <th>Other</th> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$date?></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/1"><?=$s?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/9/"><?=$vp?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/6"><?=$p?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/3"><?=$t?></a></td>      
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/5"><?=$n?></a></td>

                                            <!-- <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/22"><?=$c?></a></td> -->

                                            <td><a href="PSTDataCDetailData1/<?=$uid?>/<?=$date?>/3/6"><?=$ca?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/8"><?=$cb?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/9"><?=$cc?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/10"><?=$cd?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/11"><?=$ce?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/12"><?=$cf?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/13"><?=$cg?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/14"><?=$ch?></a></td>
                                            <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/15"><?=$ci?></a></td>
                                            <!-- <td><a href="PSTDataCDetailData/<?=$uid?>/<?=$date?>/16"><?=$ot?></a></td> -->
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
