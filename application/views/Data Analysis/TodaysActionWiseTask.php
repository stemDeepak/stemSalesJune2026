...
<div class="container">
    <hr>
        <h1 class="text-center my-4">Todays Task Actions / Status Distribution</h1>
    <hr>
    <div class="row mb-4">
        <div class="col-md-3">
    ...
    $(document).ready(function() {
        ...
        function filterData() {
            ...
            return data.filter(item => {
                ...
                return userMatch && typeMatch && statusMatch && taskMatch;
            });
        }
