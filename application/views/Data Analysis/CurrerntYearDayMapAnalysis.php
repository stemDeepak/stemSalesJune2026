    ...
    <div class="card1">
        <div class="card-body">
            <div class="text-center">
                <h3>Current Year Day Management</h3>
            </div>
        </div>
    </div>
...
<script>
    ...
    function updateMap() {
        ...
        const filteredData = data.filter(item =>
            ...
            (!startDate || new Date(item.ustart) >= new Date(startDate)) &&
            (!endDate || new Date(item.ustart) <= new Date(endDate))
        );
    ...
    document.getElementById('startDateFilter').addEventListener('change', updateMap);
    document.getElementById('endDateFilter').addEventListener('change', updateMap);
