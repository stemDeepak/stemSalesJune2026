                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4 align-items-center">
                                        <div data-mdb-input-init class="form-outline datepicker w-100">
                                            <label for="confirmPassword" class="form-label">Select Base Cluster</label>
                                            <div class="input-group">
                                                <?php $clusters =  $this->Menu_model->GetAllClusterByUSERID($uid) ?>
                                            <select class="form-control" id="cluster_id" name="cluster_id" style="width: 30% !important;">
                                                <option>Select Base Travel Cluster</option>
                                                <?php foreach($clusters as $cluster):

                                                     $inState = $this->Menu_model->getInStateById($cluster->in_state)[0]->state_title;
                                                     
                                                     $inDistrict = $this->Menu_model->getInDistricById($cluster->in_district);
                                                     ...
                                                     $in_cityid = rtrim($cluster->in_city, ',');
                                                    ...
                                                    ?>
                                                <option title="<?= $title_message; ?>"  value="<?= $cluster->id; ?>"> <?= $cluster->clustername; ?> - (<?= $cluster->name; ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                            </div>
                                        </div>
