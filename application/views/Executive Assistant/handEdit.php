              ...
              <form action="<?=base_url();?>Menu/handoverchange" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-lg-4 p-3">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="clientid" value="<?=$cid?>" required readonly>
                                <input type="text" class="form-control" name="client_name" id="client_name" value="<?=$md->client_name?>" required readonly>
                                <div class="invalid-feedback">Please provide a Company name.</div>
                                <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="form-group">
                                <label for="validationSample02">NGO / Mediator if any</label>
                                <input type="text" class="form-control" name="mediator" id="mediator" required="" value="<?=$md->mediator?>">
                                <div class="invalid-feedback">Please provide a Information.</div>
                                <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="form-group">
                                <label for="noofschool">Number of Schools</label>
                                <input type="text" class="form-control" name="noofschool" id="noofschool" required value="<?=$md->noofschool?>" readonly>
                                <div class="invalid-feedback">Please provide a Information.</div>
                                <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="form-group">
                                <label for="location">Location / Village</label>
                                <textarea class="form-control" name="location" id="location" required><?=$md->location?></textarea>
                                <div class="invalid-feedback">Please provide a Information.</div>
                                <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="form-group">
                        ...
                        <div class="col-lg-4 p-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="are_spd_identify" id="are_spd_identify" required>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select>
                                <div class="invalid-feedback">Please provide a Information.</div>
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="spd_identify_by" id="spd_identify_by" onchange="schoolFun()" required>
                                    <option><?=$md->spd_identify_by?></option>
                                    <option>STEM</option>
                        ...
                        <div class="col-lg-4 p-3">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="comments" id="comments" required><?=$md->comments?></textarea>
                                <div class="invalid-feedback">Please provide a Information.</div>
                                <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="form-group">
                                <label for="wono">Work Order No</label>
                                <input type="text" class="form-control" name="wono" id="wono" value="<?=$mdc->wono?>" required>
                              </div>
                              <div class="form-group">
                                <label for="porno">Purchase Order No</label>
                                <input type="text" class="form-control" name="porno" id="porno" value="<?=$mdc->porno?>" required>
                              </div>
                              <div class="form-group">
                                <label for="gstno">GST Number</label>
                                <input type="text" class="form-control" name="gstno" id="gstno" value="<?=$mdc->gstno?>" required>
                              </div>
                              <div class="form-group">
                                <label for="panno">Pan Number</label>
                                <input type="text" class="form-control" name="panno" id="panno" value="<?=$mdc->panno?>" required>
                              </div>
                              <div class="form-group">
                                <label for="panno">Total Budget</label>
                                <input type="number" class="form-control" name="tbudget" id="tbudget" value="<?=$mdc->tbudget?>" required onchange="Budgetper()">
                              </div>
                              <div class="form-group">
                                <label for="payterm">PAYMENT TERMS</label>
                                <textarea type="text" class="form-control" name="payterm" id="payterm"><?=$mdc->payterm?></textarea>
                              </div>
                              <div class="form-group">
                                <label for="pwosdate">Purchase Order & Work Order Signed Date</label>
                                <input type="date" class="form-control" name="pwosdate" id="pwosdate" value="<?=$mdc->pwosdate?>">
                              </div>
                              <div class="form-group">
                                <label for="moudate">MoU Signed Date</label>
                                <input type="date" class="form-control" name="moudate" id="moudate" value="<?=$mdc->moudate?>">
                              </div>
                              <div class="form-group">
                                <label for="srfinovice">Special Requirement for Invoice</label>
                                <textarea class="form-control" name="srfinovice" id="srfinovice"><?=$mdc->srfinovice?></textarea>
                              </div>
                        </div>
                    </div>
                  </div>
                ...
                <div class="row" id="container">
                    ...
                    <div id="mainsection" class="col-lg-12 col-sm p-3">
                        ...
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="sname[]" value="<?=$spdc->sname?>" readonly></div>
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="saddress[]" value="<?=$spdc->saddress?>" readonly></div>
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="scity[]" value="<?=$spdc->scity?>" readonly></div>
                        </div>
                        <div id="mainsection" class="row p-3">
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="sstate[]" value="<?=$spdc->sstate?>" readonly></div>
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="contact_name[]" value="<?=$spdc->contact_name?>" readonly></div>
                        <div class="col-lg-4 p-1 col-sm"><input type="text" class="form-control" name="contact_no[]" value="<?=$spdc->contact_no?>" readonly></div>
                        </div><hr>
                    </div>
                    <?php } ?>
                </div>
