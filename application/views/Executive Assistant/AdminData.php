    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <div>
                  <form class="p-3" method="POST" action="AdminData"><input type="date" name="sdate" class="mr-2" value="<?=$sd?>"><input type="date" name="edate" class="mr-2" value="<?=$ed?>">
                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url();?>/Menu/PSTDataDetail/9/<?=$uid?>/1/<?=$date?>/0"><?=$psc->i?></a></a></td>
