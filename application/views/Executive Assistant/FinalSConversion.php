                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table table-striped table-bordered" cellspacing="0" wi$dth="100%">
                                ...
                                <tbody>
                                    ...
                                    $getLastTask = $this->Menu_model->getLastTask($bd,$inid);
                                    $lastRemarks = $getLastTask[0]->remarks;
                                    $lastnstatus_id = $getLastTask[0]->nstatus_id;
                                    $lastappointmentdatetime = $getLastTask[0]->appointmentdatetime;
                                    $lastactiontype_id = $getLastTask[0]->actiontype_id;
                                    $lst_action = $this->Menu_model->get_actionbyid($lastactiontype_id);
                                    $lst_action_name = $lst_action[0]->name;

                                    $s1 = $this->Menu_model->get_statusbyid($lastnstatus_id);
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$lastappointmentdatetime?></td>
                                        <td><?=$nctime?></td>
                                        <td><?php if($ctime!=''){echo $this->Menu_model->timediff($lastappointmentdatetime,$nctime);}?></td>
                                        <td><?php if($mltd!=''){echo $lst_action_name;}?></td>
                                        <td><?=$mtd[0]->current_action_type?></td>
                                        <td><?=$s1?></td>
                                        <td><?=$s2?></td>
                                        <td><?=$mtd[0]->actontaken?></td>
                                        <td><?=$mtd[0]->purpose_achieved?></td>
                                        <td><?php if($mltd!=''){echo $lastRemarks; }?></td>
