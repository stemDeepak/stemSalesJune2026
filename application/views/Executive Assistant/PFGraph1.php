    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Status Wise PST Team Funnel Graph</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $status = $this->Menu_model->get_pstfannalstwise($uid);
          ...
          <div class="card col-12  p-3 text-center">
              ...
              <div class="container-fluid card p-5" id="data-container">
                <div class="row text-center" id="grid-view">
                    ...
                    $funnal = $this->Menu_model->get_pstfannal($uid);
                ?>
                    <div class="filters">
                    ...
                    <?php 
                         $mdata = $this->Menu_model->get_pstfannal($uid);
                         foreach($mdata as $dt){
                         $cid = $dt->cmpid_id;
