...
<html lang="en">
  <head>
    ...
    <title>Not With Me - Annual Company Report | STEM APP| WebAPP</title>
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                        ...
                        <div class="btn btn-primary colapsboxsha col-md-12 col-lg-12 mt-2 d-flex justify-content-between align-items-center" data-toggle="collapse" href="#collapseExample<?=$k?>" role="button" aria-expanded="false" aria-controls="collapseExample<?=$k?>">
                         <?= $utype[0]->name .' - '.$userid ?> - Annual Company Report (Not with me) : 
                                  ...
                                  <tbody>
                                    <?php 
                                     ...
                                     <tr>
                                      <td><?= $j; ?></td>
                                      <td>
                                        <a target="_BLANK" href="https://stemapp.in/Menu/AnnualReviewDetails1/<?=$revTarget->company_id ?>/<?= $revTarget->user_id ?>">
                                        <?=$this->Menu_model->get_cdbyid($revTarget->company_id)[0]->compname .' - '.$revTarget->company_id?> 
                                        </a>
                                      </td>
                                      <td>
                                       <?=$object->company_id ?>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                           <?php if($object->pst_approve == 'Approve'){ ?>
                                      ...
                                      <td>
                                           <?php if($object->cluster_approve == 'Approve'){ ?>
                                            <span class="p-2 bg-success mr-2">Approved</span>
                                            <?php }else{ ?>
                                            <span class="p-2 bg-danger mr-2">Reject</span>
                                            <?php }?>
                                      ...
                                      <td>
                                        <div>
                                          <!--<p><a href="<?=base_url();?>Menu/approveAnnualReview/<?= $revTarget->id?>/Approve" class="btn btn-success mr-2">Approve</a></p>-->
                                          <!--<p><button type="button" class="btn btn-primary"  onclick="Reject(<?= $j ?>,<?= $revTarget->id?>,'Reject')">Reject</button></p>-->
                                        </div>
                                      </td>
                                    </tr>
                                    <?php  $j++; }?>
