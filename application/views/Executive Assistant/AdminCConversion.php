  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Admin Call Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- /.content-header -->
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/AdminCConversion">
                                ...
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($mdata as $md){
                                            ...
                                            if($nsid!=''){
                                            $nsid = $this->Menu_model->get_statusbyid($nsid);}else{$nsid=$sid;}
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$inid[0]->noofschools?></td>
                                        <td><?=$inid[0]->fbudget?></td>
