                                    ...
                                    <div class="card-body box-profile">
                                        <!--<form action="<?=base_url();?>Menu/startAnnualReview" method="post">-->
                                            ...
                                            <div class="was-validated">
                                                <?php $compcount = sizeof($annualTarget); ?>
                                                ...
                                                <?=$this->Menu_model->get_cdbyid($a->company_id)[0]->compname?> - <?=$company_id ?>
                                                ...
                                                <!--<div class="collapse" id="collapseExample<?=$j?>">-->
                                                    <div class="card card-body">
                                                        <div class="ApprovedStatus">
                                                           ...
                                                           <table id="exampledata<?=$j?>" class="table table-striped table-bordered" cellspacing="0" width="">
                                                                <?php 
                                                    
                                                                if($a->keep_company == "yes"){
                                                                    ...
                                                                    <td><?=$a->closure?></td><?php }?>
                                                                       ...
                                                                       <td>
                                                                        ...
                                                                        //   echo "user_id " . $user_id;
                                                                          if($company_id[0]->answer !=''){
                                                                              $locanswer =  $this->Menu_model->getlocationinfoOfAnRev($user_id,$company_id)[0]->answer; 
                                                                                if($locanswer == 'no' or $locanswer == 'No' or $locanswer == 'NO'){
                                                                              $uplocanswer =  $this->Menu_model->getlocationinfoOfAnRevew($user_id,$company_id)[0]->location;
                                                                              echo $uplocanswer;
                                                                          }  
                                                                          }
                                                        ...
                                                        <br>
                                                         ...
                                                         <input type="hidden" value="<?=$compcount ?>" id="compcount">

                                                        
                                                          <?php 
                                                          
                                                        
                                                          $annualdatacnt = sizeof($annualdata);
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="exampledataan<?=$j?>" class="table table-striped table-bordered" cellspacing="0" width="">
                                                                <thead>
                                                                    <tr><th>Sr Number</th>
                                                                        <th>Question</th>
                                                                        <th>Answer</th>
                                                          ...
                                                          <input type="hidden" value="<?=$annualdatacnt ?>" id="compcount1">
...
$(document).ready(function(){
    $('#bd').on('change', function() {
      ...
      var compcount1 = $("#compcount1").val();
      for(var i = 1; i <= compcount1; i++)
      {
      var str = 'exampledataan'+i+'_wrapper';
      $("#exampledataan"+i).DataTable({
      "responsive": true, 
      "lengthChange": true, 
      "autoWidth": true,
      "searching": true,
