                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    <div class="bg-warning colapsboxsha text-center mt-2 mb-2">
                      <h3><i>Todays Contact Details Change Request</i></h3>
                    </div>
                            ...
                            <table id="exampledata" class="table table-striped table-bordered" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?= $todays_data->request_type ?></td>
                                  <td>
                                  <a target="_BLANK" href="<?=base_url().'Menu/CompanyDetails/'.$todays_data->cid;?>">
                                    <?= $todays_data->compname ?>
                                    </a>
                                  </td>
                                  ...
                                  <td>
                                    ...
                                    <div>
                                      <p><a href="<?=base_url();?>Menu/TodaysContactDetailsChangeRequestApproved/<?=$todays_data->id ; ?>/Approve" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?=base_url();?>Menu/TodaysContactDetailsChangeRequestReject" method="post" >
