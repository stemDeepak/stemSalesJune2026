           ...
           <div class="col-sm col-md-12 col-lg-12 m-auto">
              	<div class="card card-success card-outline">
					<div class="card-body box-profile">
						...
						elseif($key === 'task'){
                                                         $taskactionnamedata    = $this->Menu_model->get_actionbyid($SinglefilterUsed);
                                                         $tactionname           = $taskactionnamedata[0]->name;
                                       ...
                                       $meetinTypeArray = array('3','4','6','17','18');
                                            ...
                                            if($getNextActionDetails->autotask != '1'){
                                                echo $task->initiateTime;
                                                    ...
                                                    echo $task->appointmentdatetime;
                                              }
						$time_diff_plan_initiate = $task->time_diff_meetingupdateVsInitiat;
						$time_diff_initiate_update =  $task->time_diff_InitiatVsCloseMeeting;
						...
						//$avgTimeTaken = get_AvgMeetingTime($task->actiontype_id);
                                                ...
                                                $time_diff_initiate_update =  $task->time_diff_InitiatVsClose;
						$avgTimeTaken = get_AvgTime($task->actiontype_id);
                                        ...
                                        <br><br>
                                            ...
                                            ?>
                                            Time taken from initiating to update : <b> <?= $time_diff_initiate_update; ?></b><hr>
