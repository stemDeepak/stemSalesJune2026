    ...
    <script>
        ...
        const BusinessAnalyticsController = {
            ...
            config: {
                ...
                endpoints: {
                    chat: 'Chat/process', // CI3 controller/method for chat
            ...
            renderExploreCards() {
                ...
                const exploreCategories = [
                    ...
                    },
                    {
                        ...
                        cards: [
                            { icon: "🎯", title: "Closure PipeLine By ", desc: "Pipeline closure forecasting" },
                            // { icon: "🎯", title: "Closure Pipeline Details By Company", desc: "Pipeline closure Details forecasting" },
