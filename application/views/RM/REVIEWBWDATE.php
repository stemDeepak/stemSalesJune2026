  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Review B/W Date</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- /.content-header -->
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/REVIEWBWDATE">
    ...
    <select name="outask">
        <option value="0">Admin Review</option>
        <option value="1">PST Review</option>
        <option value="2">Self Review</option>
    </select>
                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                        ...
                                        $edate = $_POST["edate"];
                                        $bdid = $_POST["bdid"];
                                        $mdata=$this->Menu_model->get_bdreviewcom($sdate,$edate,$bdid,$uid);
                                        foreach($mdata as $dt){
                                            $cid = $dt->cmpid_id;
                                            $ciid = $dt->ciid;
                                            $userid = $dt->mainbd;
                                            $bd=$this->Menu_model->get_userbyid($userid);
