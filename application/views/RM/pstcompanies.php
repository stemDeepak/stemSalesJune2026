                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Positive Key Date</th>
                                            <th>Positive Key Remark</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach($mdata as $dt){
                                            ...
                                            $pid = $init[0]->apst;
                                            $bdid = $init[0]->mainbd;
                                            $cstatus = $init[0]->cstatus;
                                            if($cstatus){$sid = $init[0]->cstatus;
                                    ...
                                    <tr>
                                         ...
                                         <td><?php if(isset($init[0]->keycompany)){echo $init[0]->keycompany;}?></td>
                                         <td><?php if(isset($init[0]->kcdate)){echo $init[0]->kcdate;}?></td>
                                         <td><?php if(isset($init[0]->kcremark)){echo $init[0]->kcremark;}?></td>
                                         <td><?php if(isset($init[0]->pkclient)){echo $init[0]->pkclient;}?></td>
                                         <td><?php if(isset($init[0]->pkcremark)){echo $init[0]->pkcremark;}?></td>
                                         <td><?php if(isset($init[0]->pkdate)){echo $init[0]->pkdate;}?></td>
                                         <td><?=$contactperson?></td>
                                         <td><?=$phoneno?></td>
                                         <td><?=$emailid?></td>
                                         <td><?=$designation?></td>
                                         ...
                                         <td>
                                             <?php 
                                             $creid = $init[0]->creator_id;
                                             $creid=$this->Menu_model->get_userbyid($creid);
                                             echo $creid=$creid[0]->name;
