...
<html lang="en">
  <head>
    ...
    <title>Team Visit In Travel Cluster  | STEM APP | WebAPP</title>
                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                      <h1 class="m-0 premium-color-1" style="color: #ff009b;">Team Visit in Travel Cluster 🚗📍 </h1>
                      <p class="premium-color-2" style="color: #ff0000;">This section gives you clear insights into your funnel performance, visit progress, and team activity across the travel cluster. Stay updated on every stage, from initial engagement to final outcomes.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row mb-2">
              ...
              <div class="text-right-data text-center" style="background: linear-gradient(to right, #b2d6ff, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px; width: 60%;">
                ...
                <div class="col text-center formcenterData">
                  <div>
                    <hr>
                    <form action="<?=base_url()?>Reports/TeamVisitInTravelCluster" method="post" class="mt-3">
                      <div class="row mb-4">
                        <div class="col">
          ...
          <div class="container-fluid">
            <?php 
              ...
              <div class="card">
                ...
                <h5>
                <i>✨ Team Travel in Cluster Categorization by Cluster Name Summary</i> <br>
                <small>
                    ✨ This summary provides a clear breakdown of team travel activity across different cluster names 📍.  
                    It categorizes all records 🔢 into base visits 📍, outstation visits 🧳, entries where a cluster was marked but not set ❓,  
                    and records with no cluster assigned at all 🚫.  
                    This overview helps in understanding travel patterns, improving field planning 📆, ensuring better coverage tracking 🗺️,  
                    and enhancing data accuracy across all travel clusters 📊.
                </small>
                </h5>
              </div>
              <hr>
                ...
                <div class="table-responsive text-nowrap">
                  <table id="example12" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                      ...
                      <th>🧳 Total Planned Meeting</th>
                      <th>🧳 Total Complete Meeting</th>
                      <th>🧳 Total Pending For Meeting</th>

                      <th>🧳 Total RP Meeting</th>
                      <th>🧳 Total NO RP Meeting</th>
                      <th>🧳 Total Only Got Detail Meeting</th>
                      <th>🧳 Total Deleted Meeting</th>

                      <th>🧳 Total Complete Scheduled Meeting Meeting</th>
                      <th>🧳 Total Complete Barg in Meeting Meeting</th>
                      <th>🧳 Total Complete Virtual Meeting Meeting</th>

                      <th>🧳 Total Proposal Sent</th>
                      <th>🧳 Total Closure</th>

                      <th>Total Pending for Meeting (20 Closure Funnel) in <?= $currentQuarter ?></th>
                      <th>Total Pending for Proposal (20 Closure Funnel) in <?= $currentQuarter ?></th>
                      <th>Total Pending for Meeting (Potential Funnel) in <?= $currentQuarter ?></th>
                      <th>Total Pending for Proposal to Be Sent After Review in <?= $currentQuarter ?></th>
                    ...
                    <tbody>
                      ...
                      <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                        ...
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_planned_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_planned_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_complete_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_complete_meeting; ?>
                          </a>
                        </td>

                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_pending_for_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_pending_for_meeting; ?>
                          </a>
                        </td>
                        ...
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_rp_complete_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_rp_complete_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_no_rp_complete_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_no_rp_complete_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_ogt_complete_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_ogt_complete_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_deleted_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_deleted_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_complete_planned_sheduled_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_complete_planned_sheduled_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_complete_planned_barg_in_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_complete_planned_barg_in_meeting; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_complete_planned_virtual_meeting/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_complete_planned_virtual_meeting; ?>
                          </a>
                        </td>
                        ...
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_proposal_sent/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_proposal_sent; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_clouser/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_clouser; ?>
                          </a>
                        </td>
                        ...
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_pending_for_meeting_20_clouser_funnel/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_pending_for_meeting_20_clouser_funnel; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_pending_for_proposal_20_clouser_funnel/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_pending_for_proposal_20_clouser_funnel; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_pending_for_meeting_potential_funnel/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_pending_for_meeting_potential_funnel; ?>
                          </a>
                        </td>
                        <td>
                          <a target="_BLANK" class="card-count-heading-new" style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url()?>Reports/FunnelDetailsWithClusterIDList/total_pending_proposal_to_be_sent_after_review/<?=$meeting_user_id?>/<?=$row->cluster_id?>/userwise/<?= $sdate ?>/<?= $edate ?>">
                          <?= $row->total_pending_proposal_to_be_sent_after_review; ?>
                          </a>
                        </td>
