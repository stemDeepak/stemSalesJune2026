...
<html lang="en">
  <head>
    ...
    <title> Same Status Since (n) Days | STEM APP | WebAPP</title>
...
tbody tr td:nth-child(2) {
                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                      <h1 class="m-0 premium-color-1" style="color: #ff009b;">📌 Same Status Since (n) Days</h1>
                      <p class="premium-color-2" style="color: #ff0000;">This indicates that a task, request, or activity has remained in the same stage without any updates or progress for (n) days ⏳. It helps track delays, bottlenecks, or pending actions that require immediate attention ⚠️. Monitoring this ensures accountability, timely follow-ups, and smoother workflow management ✅. Staying too long in the same status can impact efficiency and overall productivity 📉.</p>
  ...
  <div class="col text-center formcenterData">
    <div>
      <hr>
        <form action="<?=base_url()?>Reports/SameStatusSinceDays" method="post" class="mt-3">
            <div class="row mb-4">
