            ...
            <div class="row mb-2">
              ...
              <div class="text-right-data text-center" style="background: linear-gradient(to right, #d7faff, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                ...
                <div class="col text-center formcenterData">
                  <div>
                    <hr>
                    <form action="<?=base_url()?>Reports/SpecialRemarksLeadsCurrentFY" method="post" class="mt-3">
                      <div class="row mb-4">
                        <div class="col">
                        ...
                        <div class="col">
                          ...
                          <select class="form-control" name="task_action" style="width: fit-content;">
                            ...
                            <?php 
                              if($taskAction->action_status == 0 || $taskAction->id !=1){
                                continue;
                              } ?>
        ...
        <div class="card-body" style="color:<?=$backgroundColorNew;?>!important">
          ...
          <div class="text-center">
            ...
            <h4>
             ...
             href="<?=base_url()?>Reports/SpecialRemarksLeadsCurrentFYLists/<?=$details['task_user_id']?>/<?=$sdate?>/<?=$edate?>">
