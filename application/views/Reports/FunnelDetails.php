...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
      <title> Funnel Task Details | STEM APP | WebAPP</title>
                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                      ...
                      <p class="premium-color-2" style="color: #ff0000;">This section provides a details overview of all company, including relevant details.</p>
                      <?php 
                ...
                foreach ($totalTasksUserByDatas as $row) {
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="<?=$meeting_task_id?>">
                        ...
                        if(!empty($row->acm_co_id_name) && !is_null($row->acm_co_id_name)){
                         ...
                         ?></td>
                        <td><?php 
                        if(!empty($row->inside_bd_name) && !is_null($row->inside_bd_name)){
                            echo htmlspecialchars($row->inside_bd_name);
                        }else{
                            echo 'NA';
                        }
                         ?></td>
                    ...
                    <?php } ?>
                      ...
                      <td class="text-capitalize"><?=$row->company_address;?></td>
                        ...
                        <td class="text-capitalize"><?php 
                        if(!empty($row->need_to_be_monitored) && !is_null($row->need_to_be_monitored)){ ?>
                            <span class="live-badge text-center"><span class="live-dot"></span> <?= $row->need_to_be_monitored; ?> </span>
                        <?php }else{
                            echo 'NA';
                        }
                         ?></td>
