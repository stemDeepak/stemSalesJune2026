                    ...
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                      ...
                      if($mtypes == 'total_plan_meetings'){
                        ...
                        $filter = ' Total Pending For Check MOM Data';
                          ...
                          $filter = 'Update in Gretter than 120 Minutes';
                      }else if ($mtypes == 'thirteen_to_sixty') {
                          $filter = 'Update in 30 to 60 Minutes';
                      }else if ($mtypes == 'gretter_than_sixty') {
                          $filter = 'Update in Gretter than 60 Minutes';
                      ...
                      }else if ($mtypes == 'total_open') {
                         $filter = 'total in Open Status';
                      }else if ($mtypes == 'total_reachout') {
                         $filter = 'total in reachout Status';
                      }else if ($mtypes == 'total_tentative') {
                         $filter = 'total in tentative Status';
                      }else if ($mtypes == 'total_will_do_later') {
                         $filter = 'total in will do later Status';
                      }else if ($mtypes == 'total_not_interested') {
                         $filter = 'total in not interested Status';
                      }else if ($mtypes == 'total_positive') {
                         $filter = 'total in positive Status';
                      }else if ($mtypes == 'total_closure') {
                         $filter = 'total in closure Status';
                      }else if ($mtypes == 'total_open_rpem') {
                         $filter = 'total in open rpem Status';
                      }else if ($mtypes == 'total_very_positive') {
                         $filter = 'total in very positive Status';
                      }else if ($mtypes == 'total_ttd_reachout') {
                         $filter = 'total in ttd reachout Status';
                      }else if ($mtypes == 'total_wno_reachout') {
                         $filter = 'total in wno reachout Status';
                      }else if ($mtypes == 'total_positive_nap') {
                         $filter = 'total in positive nap Status';
                      }else if ($mtypes == 'total_very_positive_nap') {
                         $filter = 'total in very positive nap Status';
                      }else if ($mtypes == 'total_on_boarded') {
                         $filter = 'total in on boarded Status';
                      }else if ($mtypes == 'total_RP_in_open') {
                         $filter = 'total RP in Open Status';
                      }else if ($mtypes == 'total_RP_in_reachout') {
                         $filter = 'total RP in reachout Status';
                      }else if ($mtypes == 'total_RP_in_tentative') {
                         $filter = 'total RP in tentative Status';
                      }else if ($mtypes == 'total_RP_in_will_do_later') {
                         $filter = 'total RP in will do later Status';
                      }else if ($mtypes == 'total_RP_in_not_interested') {
                         $filter = 'total RP in not interested Status';
                      }else if ($mtypes == 'total_RP_in_positive') {
                         $filter = 'total RP in positive Status';
                      }else if ($mtypes == 'total_RP_in_closure') {
                         $filter = 'total RP in closure Status';
                      }else if ($mtypes == 'total_RP_in_open_rpem') {
                         $filter = 'total RP in open rpem Status';
                      }else if ($mtypes == 'total_RP_in_very_positive') {
                         $filter = 'total RP in very positive Status';
                      }else if ($mtypes == 'total_RP_in_ttd_reachout') {
                         $filter = 'total RP in ttd reachout Status';
                      }else if ($mtypes == 'total_RP_in_wno_reachout') {
                         $filter = 'total RP in wno reachout Status';
                      }else if ($mtypes == 'total_RP_in_positive_nap') {
                         $filter = 'total RP in positive nap Status';
                      }else if ($mtypes == 'total_RP_in_very_positive_nap') {
                         $filter = 'total RP in very positive nap Status';
                      }else if ($mtypes == 'total_RP_in_on_boarded') {
                         $filter = 'total RP in on boarded Status';
                      }else if ($mtypes == 'total_NO_RP_in_open') {
                         $filter = 'total NO RP in Open Status';
                      }else if ($mtypes == 'total_NO_RP_in_reachout') {
                         $filter = 'total NO RP in reachout Status';
                      }else if ($mtypes == 'total_NO_RP_in_tentative') {
                         $filter = 'total NO RP in tentative Status';
                      }else if ($mtypes == 'total_NO_RP_in_will_do_later') {
                         $filter = 'total NO RP in will do later Status';
                      }else if ($mtypes == 'total_NO_RP_in_not_interested') {
                         $filter = 'total NO RP in not interested Status';
                      }else if ($mtypes == 'total_NO_RP_in_positive') {
                         $filter = 'total NO RP in positive Status';
                      }else if ($mtypes == 'total_NO_RP_in_closure') {
                         $filter = 'total NO RP in closure Status';
                      }else if ($mtypes == 'total_NO_RP_in_open_rpem') {
                         $filter = 'total NO RP in open rpem Status';
                      }else if ($mtypes == 'total_NO_RP_in_very_positive') {
                         $filter = 'total NO RP in very positive Status';
                      }else if ($mtypes == 'total_NO_RP_in_ttd_reachout') {
                         $filter = 'total NO RP in ttd reachout Status';
                      }else if ($mtypes == 'total_NO_RP_in_wno_reachout') {
                         $filter = 'total NO RP in wno reachout Status';
                      }else if ($mtypes == 'total_NO_RP_in_positive_nap') {
                         $filter = 'total NO RP in positive nap Status';
                      }else if ($mtypes == 'total_NO_RP_in_very_positive_nap') {
                         $filter = 'total NO RP in very positive nap Status';
                      }else if ($mtypes == 'total_NO_RP_in_on_boarded') {
                         $filter = 'total NO RP in on boarded Status';
                      }else if ($mtypes == 'total_OGD_in_open') {
                         $filter = 'total Only Got Detail in Open Status';
                      }else if ($mtypes == 'total_OGD_in_reachout') {
                         $filter = 'total Only Got Detail in reachout Status';
                      }else if ($mtypes == 'total_OGD_in_tentative') {
                         $filter = 'total Only Got Detail in tentative Status';
                      }else if ($mtypes == 'total_OGDP_in_will_do_later') {
                         $filter = 'total Only Got Detail in will do later Status';
                      }else if ($mtypes == 'total_OGD_in_not_interested') {
                         $filter = 'total Only Got Detail in not interested Status';
                      }else if ($mtypes == 'total_OGD_in_positive') {
                         $filter = 'total Only Got Detail in positive Status';
                      }else if ($mtypes == 'total_OGD_in_closure') {
                         $filter = 'total Only Got Detail in closure Status';
                      }else if ($mtypes == 'total_OGD_in_open_rpem') {
                         $filter = 'total Only Got Detail in open rpem Status';
                      }else if ($mtypes == 'total_OGD_in_very_positive') {
                         $filter = 'total Only Got Detail in very positive Status';
                      }else if ($mtypes == 'total_OGD_in_ttd_reachout') {
                         $filter = 'total Only Got Detail in ttd reachout Status';
                      }else if ($mtypes == 'total_OGD_in_wno_reachout') {
                         $filter = 'total Only Got Detail in wno reachout Status';
                      }else if ($mtypes == 'total_OGD_in_positive_nap') {
                         $filter = 'total Only Got Detail in positive nap Status';
                      }else if ($mtypes == 'total_OGD_in_very_positive_nap') {
                         $filter = 'total Only Got Detail in very positive nap Status';
                      }else if ($mtypes == 'total_OGD_in_on_boarded') {
                         $filter = 'total Only Got Detail in on boarded Status';
                      }else if ($mtypes == 'total_new_company') {
                         $filter = 'Total New Company';
                      }else if ($mtypes == 'total_new_company_complete') {
                          $filter = 'Total New Company Meeting Complete';
                      }else if ($mtypes == 'total_new_company_pending') {
                          $filter = 'Total New Company Meeting Pending';
                      }else if ($mtypes == 'total_new_company_RP_meetings') {
                          $filter = 'Total New Company RP meetings ';
                      }else if ($mtypes == 'total_new_company_NO_RP_meetings') {
                          $filter = 'Total New Company No RP meetings';
                      }else if ($mtypes == 'total_new_company_Only_Got_details_meetings') {
                          $filter = 'Total New Company Only Got Details Meetings ';
                      }else if ($mtypes == 'total_new_company_potential_rp_meetings') {
                         $filter = 'Total New Company Potential RP Meetings';
                      }else if ($mtypes == 'total_new_company_non_rp_potential_meetings') {
                          $filter = 'Total New Company Non Potential RP Meetings';
                      }else{
                        $filter = $mtypes;
                      }
                      ?>
    ...
    color: black;
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            if($mtypes !== 'total_NO_RP_meetings'){ ?>
                <a class="p-1 bg-success p-2" target="_BLANK" href="<?= base_url()?>MomController/download_all_mom_pdfFile/<?=$mtypes?>/<?=$target_uid?>/<?=$sdate?>/<?=$edate?>">Download All Mom</a>
               <?php } ?>
            <hr>
            </center>
                ...
                <div class="table-responsive text-nowrap" style="overflow-x: auto;">
                  ...
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th class="text-capitalize">📅 Company Create Date</th>
                      <th class="text-capitalize">👨‍💼 Main BD</th>
                      <th class="text-capitalize">👨‍💼 Inside Sales Name</th>
                      ...
                      <th class="text-capitalize">🏷️ Company As</th>
                      <th class="text-capitalize">🧾 Company Descriptions</th>
                      <th class="text-capitalize">📊 meetings status</th>
                      <th class="text-capitalize">💼 BD Marked Business Potential for this FY </th>

                      <th class="text-capitalize">💼 BD Marked Proposal Status </th>
                      ...
                      <?php if($comming_user_types == 2 || $comming_user_types == 1){ ?> 
                      ...
                      <?php 
                      /*
                      if($comming_user_types == 2 || $comming_user_types == 1){ ?> 
                      <th class="text-capitalize">🔁 No RP TO RP Convert</th>
                      <?php }
                      */
                       ?>
                      
                      <th class="text-capitalize">📄 View MOM</th>
                      <th class="text-capitalize">✏️ Short mom</th>
                      ...
                      <th class="text-capitalize">💸 Anchor Clients</th>
                      ...
                      <th class="text-capitalize">💸 Cash Expense</th>
                      <th class="text-capitalize">🧾 Expense Type</th>
                      <th class="text-capitalize">💬 Expense Remarks</th>
                      <th class="text-capitalize">📎 Expense Details</th>

                      <th class="text-capitalize">🔁 Task RePlanned Count</th>
                      <th class="text-capitalize">📍 Travel Cluster Name</th>
            ...
            <tbody>
                ...
                foreach ($totalMeetingsUserByDatas as $row) {
                  ...
                  $norp_by_admin = $row->norp_by_admin;
                  ...
                  $meetExpense =  $this->Report_model->GetSingleMeetingExpenseDetails($meeting_task_id);

                  if(sizeof($meetExpense) > 0){
                      $expense_cash_id     = $meetExpense[0]->id;
                      $expense_cash     = $meetExpense[0]->expense;
                      $expense_type     = $meetExpense[0]->expense_type;
                      $expense_remarks  = $meetExpense[0]->expense_remarks;
                      $expense_bills    = $meetExpense[0]->bills;
                  }else{
                      $expense_cash_id     = '';
                      $expense_cash     = '';
                      $expense_type     = '';
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="<?=$meeting_task_id?> - <?=$norp_by_admin?>">
                        ...
                        <td><?= htmlspecialchars($row->company_createDate) ?></td>
                        <td><?= htmlspecialchars($row->mainbd_name) ?></td>
                        <td class="text-center"><?php if(!empty($row->inside_sales_name)){echo $row->inside_sales_name;}else{echo "NA";} ?></td>
                        <td><?= htmlspecialchars($row->meetings_time_status) ?></td>
                        ...
                        */ ?>
                        ...
                        if($row->meetings_status == 'Pending'){
                            echo "<span class='bg-warning p-1'> Pending </span>"; 
                        }else if($row->meetings_status == 'RPClose' || $row->meetings_status == 'Close' || $row->meetings_status == 'RP' || $row->meetings_status == 'Change RP'){
                            echo "<span class='bg-success p-1'> Complete </span>"; 
                        ...
                        if (isset($row->business_potentional_client) && $row->business_potentional_client !== '' && $row->business_potentional_client !== null) {
                            if($row->business_potentional_client == 'NULL'){
                              echo 'NA';
                            }else{
                              echo htmlspecialchars($row->business_potentional_client);
                            }
                        }else{
                            echo 'NA';
                        }
                         ?></td>
                        <td class="text-capitalize"><?php 
                        if (isset($row->proposalStatus) && $row->proposalStatus !== '' && $row->proposalStatus !== null) {
                            if($row->proposalStatus == 'NULL'){
                              echo 'NA';
                            }else{
                              echo htmlspecialchars($row->proposalStatus);
                            }
                        }else{
                            echo 'NA';
                        }
                        ...
                        <?php }?>
                         ...
                         <?php if($comming_user_types == 2 || $comming_user_types == 1){ ?> 
                         <td>
                          <?php if($row->mtype == 'RP' || $row->mtype == 'RPClose' || $row->mtype == 'Change RP'){ ?> 
                         ...
                         <?php /*
                         <td>
                          <?php if(!empty($row->norp_by_admin)){ ?> 
                         <span type="button" class="bg-danger p-1"  onclick="RevertInToRP(<?= $i ?>,<?= $meeting_task_id ?>,'RP')">Click</span>
                         <?php } ?>
                         </td>
                         */ ?>
                        ...
                        <td class="text-capitalize"><?= htmlspecialchars($row->pkclient) ?></td>
                        <td class="text-capitalize"><?= htmlspecialchars($row->priorityc) ?></td>
                        <td class="text-capitalize"><?= htmlspecialchars($row->anchor_clients) ?></td>
                        ...
                        <td><?= $expense_cash; ?> ₹</td>
                        <td><?= $expense_type; ?></td>
                        <td><?= $expense_remarks; ?></td>
                        <td>
                         <?php if($expense_cash_id !=''){ ?>
                           <a style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url();?>Menu/TravelCashExpenseAdvancedDetails/<?=$expense_cash_id;?>" target="_BLANK">View</a>
                          <?php }else{
                            echo "NA";
                          } ?>
                      </td>
                        ...
                        <td>
                          <?php if($row->cluster_id !=''){ ?> 
                            <a style="color:<?=$backgroundColorNew;?>!important" href="<?=base_url();?>Menu/TravelClusterDetailsByID/<?=$row->cluster_id;  ?>" target="_BLANK"><?= $row->cluster_name; ?> ( <?=$row->cluster_travelType?> )</a>
                            <?php }else { ?> 
                              NA
                              <?php } ?>
                        </td>
                        ...
                        <td> 
                          <?php 
                           if($row->nextCFID > 0) { ?>
                            <a class="bg-success p-1" href="<?= base_url(); ?>Reports/ViewMeetingDetails/<?= $meeting_task_id; ?>" target="_blank">View Details</a>
                        <?php } else { ?>
        ...
        <div class="modal fade" id="exampleModalCenterdata" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color: #d1e7ff;">
                                    <h5 class="modal-title text-center" style="color: red;" id="exampleModalLongTitle"><b><u>RP</u></b> to <b><u>No RP</u></b> Convert</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body" style="background-color: #ffc4c45c;">
                                   <form action="<?=base_url();?>Reports/ReportNoRPConvertAfterChecking" method="post" >
          ...
          <?php } ?>
        <?php if($comming_user_types == 2 || $comming_user_types == 1){ ?> 
        <div class="modal fade" id="exampleModalCenterdataRevertInToRP" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color: #d1e7ff;">
                                    <h5 class="modal-title text-center" style="color: red;" id="exampleModalLongTitle"><b><u>NO RP</u></b> to <b><u>RP</u></b> Convert</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body" style="background-color: #ffc4c45c;">
                                   <form action="<?=base_url();?>Reports/ReportNoRPToRPConvertAfterChecking" method="post" >

                                        <input type="hidden" value="<?=$mtypes;?>" required name="mtypes">
                                        <input type="hidden" value="<?=$target_uid;?>" required name="target_uid">
                                        <input type="hidden" value="<?=$sdate;?>" required name="sdate">
                                        <input type="hidden" value="<?=$edate;?>" required name="edate">
                                        <input type="hidden" id="norp_id" value="" required name="no_rp_task_id">

                                         <div class="mb-3 mt-3">
                                          <textarea name="no_rp_remarks" cols="30" placeholder="Write Reason To Revert Meeting in RP " class="form-control beautiful-textarea" required  rows="4"></textarea>
                                        </div>
                                        <div class="form-group text-center">
                                            <button type="submit" class="btn btn-success mt-2">Convert Meeting in RP</button>
                                        </div>
                                   </form>
                                  </div>
                                </div>
      ...
      <!-- jQuery -->
       <script>
         ...
         function RevertInToRP(mid,id,val){
                // alert(mid);
                // alert('#exampleModalCenterdata'+mid);
                $('#exampleModalCenterdataRevertInToRP').modal('show');
                $('#norp_id').val(id);
            // $('#exampleModalCenterdata'+mid).modal('show');
            // $('#exampleModalCenterdata'+mid+' #rejectid').val(id);
            }
