...
<html lang="en">
  <head>
    ...
    <title>Day Management Star Rating | STEM APP | WebAPP</title>
                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3">
                      <h1 class="m-0 premium-color-1" style="color: #ff009b;">Day Management Star Rating ✨</h1>
                      ...
                      <p class="premium-color-2" style="color: #056c09ff;"><strong><mark><?=$targetDetails[0]->name ?></mark></strong></p>
...
?>
            ...
            <tbody>
                ...
                foreach ($totalStarsDatas as $row) {
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="<?=$meeting_task_id?>">
                        ...
                        <td>
                    <a class="bg-success p-1" target="_BLANK" href="<?=base_url()?>/Reports/DayManagementStarRatingDetails/<?=$meeting_user_id?>/<?= $sdate ?>/<?= $edate?>">
                View
                </a>
                    </td>
                    </tr>
            ...
            <tbody>
                <?php
                $i = 1;
                foreach ($totalStarsDatasQuestionByDate as $row) {
                  $meeting_user_id      = $row->day_user_id;
                  $r = rand(150, 255);
                  $g = rand(150, 255);
                  $b = rand(150, 255);
                     ...
                     <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                        ...
                        ?>
                            ...
                            <?php if(isset($userStars[$user])){
                                 ?>
                                <a class="bg-success p-1" target="_BLANK" href="<?=base_url()?>/Reports/DayManagementStarRatingDetails/<?=$totalsUsersID[$key]?>/<?= $date ?>/<?= $date?>/approved_by">
