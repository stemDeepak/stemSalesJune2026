                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3">
                      <h1 class="m-0 premium-color-1" style="color: #ff009b;">🔄 Funnels Transfer Details</h1>
                      <p class="premium-color-2" style="color: #ff0000;">📂 Funnels Transfer Details 🔄 provide a clear view of company movements 🏢, including sender 👤, receiver 🎯, status ✅, remarks 💬, and timeline ⏳ for better tracking 📊.</p>
            ...
            <div class="row mb-2">
              ...
              <div class="text-right-data text-center" style="background: linear-gradient(to right, #d7faff, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                ...
                <div class="col text-center formcenterData">
                  <div>
                    <hr>
                    <form action="<?=base_url()?>Reports/FunnelTransferDetails" method="post" class="mt-3">
                      <div class="row mb-4">
                        <div class="col">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="text-center" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
              <h5><i>📝 Total Funnel Transfer Log</i></h5>
              <small>
                📝 The Total Funnel Transfer Log 📊 tracks all company transfers 🔄, showing sender 👤, receiver 🎯, status ✅, remarks 💬, and date 📅 for smooth workflow management 🚀.
              </small>
            </div>
            ...
            <tbody>
                <?php
                $i = 1;
                foreach ($funneltransferLogs as $row) {
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="Funnel Transfer Log ID - <?=$row->ftl_id ?>">
                        <td><?= $i ?></td>
                
                        <td>
                            <a style="color:<?=$backgroundColorNew;?>!important" target="_BLANK" href="<?=base_url();?>/Menu/CompanyDetails/<?=$row->cid?>">
                                <?= $row->compname ?>
                            </a>
                        </td>
                          <td>
