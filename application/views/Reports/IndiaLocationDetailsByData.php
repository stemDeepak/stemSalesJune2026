                ...
                <div class="frame-layer-1">
                  <div class="frame-layer-2">
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                      ...
                      <p class="premium-color-2 text-capitalize" style="color:rgb(16, 238, 0);"><strong><mark><?=$keys ?></mark></strong></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="container-fluid">
            ...
            <div class="body-content">
              <div class="page-header">
                ...
                <?php if($keys == 'total_state'){ ?>

                  <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead class="thead-dark">
                    <tr>
                        <th class="text-capitalize">Sr. NO</th>
                        <th class="text-capitalize">State ID</th>
                        <th class="text-capitalize">State Name</th>
                    </tr>
                </thead>
            <tbody>
                <?php
                ...
                foreach ($getLocations as $row) {
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="<?=$meeting_task_id?>">
                        ...
                        <td class="text-capitalize"><?= htmlspecialchars($row->state_title) ?></td>
                    </tr>
              <?php $i++; } ?>
            </tbody>
                  </table>
            <?php } ?>
                  ...
                  <?php 
                  if($keys == 'total_districts'){ ?>

                  <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead class="thead-dark">
                    <tr>
                        <th class="text-capitalize">Sr. NO</th>
                        <th class="text-capitalize">District ID</th>
                        <th class="text-capitalize">State Name</th>
                        <th class="text-capitalize">District Name</th>
            ...
            <tbody>
                ...
                foreach ($getLocations as $row) {
                  ...
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important" title="<?=$meeting_task_id?>">
                        <td><?= htmlspecialchars($i) ?></td>
                        <td><?= htmlspecialchars($row->districtid) ?></td>
                         <td class="text-capitalize"><?= htmlspecialchars($row->state_title) ?></td>
                        <td class="text-capitalize"><?= htmlspecialchars($row->district_title) ?></td>
                ...
                //   dd($getLocations);
                  ...
                  <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-capitalize">State Name</th>
                        <th class="text-capitalize">District Name</th>
                        <th class="text-capitalize">City Name</th>
