                ...
                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href='<?=base_url();?>/Menu/TBMDFRP_PST/5/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$rpm?> <?php $trpm=$trpm+$rpm;?></a></td>
                            <td><a href='<?=base_url();?>/Menu/TBMDFRP_PST/10/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$fmeet?> <?php $tfmeet=$tfmeet+$fmeet;?></a></td>
                            <td><a href='<?=base_url();?>/Menu/TBMDFRP_PST/11/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$rmeet?> <?php $trmeet=$trmeet+$rmeet;?></a></td>
                            <td><a href='<?=base_url();?>/Menu/TBMDFRP_PST/12/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$nmom?></a></td>
