              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <form action="<?=base_url();?>Menu/rejectAnnualReview" method="post" >
                                ...
                                <table id="exampledata<?=$k?>" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><?= $revTarget->closure ?></td>
                                      <td><?php 
                                        if($revTarget->pst_approve == ''){ ?>
                                        <span class="p-2 bg-warning mr-2">Pending</span>
                                        <?php }else if($revTarget->pst_approve == 'Approve'){ ?>
                                        <span class="p-2 bg-success mr-2">Approve</span>
                                        <?php }else{ ?>
                                        <span class="p-2 bg-danger mr-2">Reject</span>
                                        <div class="bg-info mt-2">
                                            <?=$revTarget->pst_remark?>
                                        </div>
                                        <?php }?>
                                      </td>
                                      <td>  
                                        <?php 
                                          if($revTarget->pst_name == ''){ ?>
                                        <span class="p-2 bg-warning mr-2">Pending</span>
                                        <?php }else{ ?>
                                        <span><?= $revTarget->pst_name ?></span>
                                        <?php } ?>
                                      </td>
                                      <td><?php 
                                        if($revTarget->cluster_approve == ''){ ?>
                                        <span class="p-2 bg-warning mr-2">Pending</span>
                                        <?php }else if($revTarget->cluster_approve == 'Approve'){ ?>
                                        <span class="p-2 bg-success mr-2">Approve</span>
                                        <?php }else{ ?>
                                        <span class="p-2 bg-danger mr-2">Reject</span>
                                        <div class="bg-info mt-2">
                                            <?=$revTarget->cluster_remark?>
                                        </div>
                                        <?php }?>
                                      </td>
                                      <td>  
                                        <?php 
                                          if($revTarget->cluster_name == ''){ ?>
                                        <span class="p-2 bg-warning mr-2">Pending</span>
                                        <?php }else{ ?>
                                        <span><?= $revTarget->cluster_name ?></span>
                                        <?php } ?>
                                      </td>
                                      <td><?php
                                        if($revTarget->is_admin_approved == ''){ ?>
