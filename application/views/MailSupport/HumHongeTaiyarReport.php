                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/faq/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/faq/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/faq/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><?php 
                                                        ...
                                                        <?php }else if($a->is_approve == 'Approve'){ ?>
                                                      ...
                                                      <td>  
                                                        <?php 
                                                          if($a->is_approve_remark == ''){ ?>
                                                        <span class="p-2 bg-warning mr-2">Pending</span>
                                                        <?php }else{ ?>
                                                        <span><?= $a->is_approve_remark ?></span>
                                                        <?php } ?>
                                                      </td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salesppt/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salesppt/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salesppt/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salespitch/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salespitch/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/salespitch/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/presentation/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/presentation/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/presentation/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/proposal/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/proposal/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/proposal/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/email/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/email/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/email/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/whatsapp/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/whatsapp/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/whatsapp/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/regional-case-study/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/regional-case-study/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/regional-case-study/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/quarter1-ppt/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/quarter1-ppt/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/quarter1-ppt/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/annualreview/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/annualreview/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/annualreview/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/district-permission/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/district-permission/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/district-permission/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <td><?=$t->name?></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/school/is_approve/approve"><?=$udata['pst_approve'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/school/is_approve/reject"><?=$udata['pst_reject'][$t->user_id]?></a></td>
                                          <td><a href="<?=base_url();?>Menu/AllResourceDetailsData/<?=$t->user_id?>/school/is_approve/pending"><?=abs($udata['total'][$t->user_id] - ($udata['pst_approve'][$t->user_id] + $udata['pst_reject'][$t->user_id]))?></a></td>
