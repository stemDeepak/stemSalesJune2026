    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12 p-3 text-center">
              <?php $tsn = $this->Menu_model->get_timeslotbyid($ts);?>
              <center><h5>Completed <?=$t1=$tsn[0]->time1?> to <?=$t2=$tsn[0]->time2?> Time Slot Task | Date : <?php echo $tdate="2023-08-08";?></h5></center><hr>
             <div class="row">
                 <?php
                 $mtdata = $this->Menu_model->new_tttswdetail($t1,$t2,$uid,$tdate,1);
                 ...
                 <div class="col-lg-3 col-md-6 col-sm p-3 <?=$action[0]->color?> rounded border">
                    ...
                    Time Slot<br><b><?=$tsn[0]->time1?> to <?=$tsn[0]->time2?></b><hr>
