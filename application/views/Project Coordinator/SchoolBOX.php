          ...
          <div class="row text-center">
                ...
                foreach($mdata as $dt){?>
                    <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                      <a href="<?=base_url();?>Menu/SPDTASKBOX/<?=$dt->sid?>" target="_blank">
                      <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                             ...
                             Address<br><b><?=$dt->saddress?>, <?=$dt->scity?>, <?=$dt->sstate?></b><hr>
                             PIA Involve<br><b><?=$dt->pia?></b><hr>
                             IMP Involve<br><b><?=$dt->imp?></b><hr>
                             Last Update On<br><b><?=$updatedt=$dt->spdudt?></b><hr>
                             Time Diffrence<br><b><?=$this->Menu_model->timediff($updatedt,$cdate);?></b><hr>
