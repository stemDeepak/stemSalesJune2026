              ...
              <div class="card-header p-0 border-bottom-0">
                ...
                Reviews<span class="badge badge-success">0</span>
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-school-indentification-tab" data-toggle="pill" href="#custom-tabs-four-school-indentification" role="tab" aria-controls="custom-tabs-four-school-indentification" aria-selected="false">
                      School Indentification <span class="badge badge-success"><?=$ttbyd[0]->rns?></span>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-call-on-school-tab" data-toggle="pill" href="#custom-tabs-four-call-on-school" role="tab" aria-controls="custom-tabs-four-call-on-school" aria-selected="false">
                      Call On School <span class="badge badge-success"><?=$ttbyd[0]->callons?></span>
                    </a>
                  </li>
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                      ...
                      <div id="accordion">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-four-school-indentification" role="tabpanel" aria-labelledby="custom-tabs-four-school-indentification-tab">
                              <?php $aai = 0;foreach($totalt as $tt){
                                if($tt->plan==1){
                                if($tt->actiontype_id=='25'){
                                  $taid   = $tt->actiontype_id;
                                  $taid   = $this->Menu_model->get_actionbyid($taid);
                                  $time   = $tt->appointmentdatetime;
                                  $time   = date('h:i a', strtotime($time));
                        ...
                        <div class="tab-pane fade" id="custom-tabs-four-call-on-school" role="tabpanel" aria-labelledby="custom-tabs-four-call-on-school-tab">
                              <?php $aai = 0;foreach($totalt as $tt){
                                if($tt->plan==1){
                                if($tt->actiontype_id=='26'){
                                  $taid   = $tt->actiontype_id;
                                  $sid    = $tt->sid;
                                  $taid   = $this->Menu_model->get_actionbyid($taid);
                                  $time   = $tt->appointmentdatetime;
                                  ...
                                  $sname  = $this->Menu_model->get_school_detailbyid($sid)[0]->sname;
                              ...
                              ?>
                                <div class="list-group-item list-group-item-action" style='background: linear-gradient(to right, #e1fff1, #ffffff);'>
                                  ...
                                  <span class="flex"><?=$taid[0]->name?> | 
                                      <strong class="text-secondary mr-1"><?=$sname?></strong> - 
                                      <strong class="text-secondary mr-1"><?=$tt->compname?></strong><br>
                                      <small class="text-muted">Task Time:- <?=$time?></small>
                                    </span>
                                    <span class="p-3" style="color:<?=$tt->color?>;"><?=$tt->name?>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-research" role="tabpanel" aria-labelledby="custom-tabs-four-research-tab">
                   ...
                   <div class="tab-pane fade" id="custom-tabs-four-virtual-meeting" role="tabpanel" aria-labelledby="custom-tabs-four-virtual-meeting-tab">
                           ...
                           <?php 
                            ...
                            if($vm_meeting->status=='RPClose' OR $vm_meeting->status == 'Change RP'){
                            ?>
                            <hr>
    ...
    // add this on top
            ...
            <?php } ?>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-barg" role="tabpanel" aria-labelledby="custom-tabs-four-barg-tab">
                            ...
                            <?php foreach($barg as $br){if($br->status=='RPClose' || $br->status=='RP' || $br->status == 'Change RP'){
