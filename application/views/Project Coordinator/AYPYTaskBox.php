    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Action Taken Yes Purpose Yes Task | Date : <?php echo $tdate="2023-08-08";?></h5></center><hr>
             <div class="row">
                 <?php
                 $mtdata = $this->Menu_model->get_bwdalltaskdbyad('9','1',$uid,$tdate,$tdate,0);
