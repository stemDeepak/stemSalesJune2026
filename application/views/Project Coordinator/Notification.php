...
<body class="hold-transition sidebar-mini layout-fixed" onload="mypopup()">
...
<div id="mynotify" class="modal fade in" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content row border border-success rounded">
			<div class="modal-header custom-modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
			</div>
			<div class="modal-body">
				<h3 class="text-success text-center">Notification!</h3>
