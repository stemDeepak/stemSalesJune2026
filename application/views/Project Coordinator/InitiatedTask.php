  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Initiated Task</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <section class="content p-3">
                    ...
                    <div class="container-fluid card p-5" id="data-container">
                        <div class="row text-center" id="grid-view">
                            <?php
                            $gdata = $this->Menu_model->get_initiatedtask($uid, $sd, $ed, $code);
                            foreach ($gdata as $gd) {
                                ?>
                                <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                                    <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                        ...
                                        Company Status<br><b style="color:<?=$gd->csclr?>"><?=$gd->cstatus?></b><hr>
                            ...
                            foreach ($gdata as $gd) {
                                ?>
                                        ...
                                        <tr>
                                         ...
                                         <td><b style="color:<?=$gd->csclr?>"><?=$gd->cstatus?></b></td>
