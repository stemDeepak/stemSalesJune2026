                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tr>
                                        <td><?=$i?></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMD/4/<?=$uid?>/<?=$sd?>/<?=$ed?>'><?=$tt?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/5/<?=$sd?>/<?=$ed?>/<?=$uid?>'><?=$rpm?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/10/<?=$sd?>/<?=$ed?>/<?=$uid?>'><?=$fmeet?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/11/<?=$sd?>/<?=$ed?>/<?=$uid?>'><?=$rmeet?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/12/<?=$sd?>/<?=$ed?>/<?=$uid?>'><?=$nmom?></a></td>
