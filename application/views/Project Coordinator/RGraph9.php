...
<div style="width: 80%; margin: auto;">
   <canvas id="combinedChartID1"></canvas>
    ...
    <?php 
        ...
        var combinedData1 = {
            labels: [<?php $bdrmodel = $this->Menu_model->get_nhprocess(); $i=1; foreach($bdrmodel as $bdrm){?> '<?=$bdrm->tmane?>', <?php } ?>],
            datasets: [
                {
                    label: '<?=$bdrm->tmane?>',
                    backgroundColor: ['red','red','red','red','red','red','red','red','red','red','red','red','red','red'],
                    data: [
                        <?php $bdrmodel = $this->Menu_model->get_bdrmodel($uid); $i=1; foreach($bdrmodel as $bdrm){ ?>
                        <?=$bdrm->cont?>,
                        <?php } ?>],
                        stack: 'Stack 0' 
                }, 
