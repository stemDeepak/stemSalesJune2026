...
<div class="container-fluid p-3">
    <form action="<?=base_url();?>Menu/Meeting" method="POST" target="_blank">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Meeting Dashboard</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" wi$dth="100%">
                                    ...
                                    <tbody>
                                        <?php foreach($mdata as $dt){
                                        
                                         $datetime= $dt->appointmentdatetime;
                                        $datetime1=date('d F Y h:i:s',strtotime($datetime));
                                    ...
                                    <tr>
                                         ...
                                         <td> <?=$dt->name?> </td>
                                         <td> <?=$dt->compname?></td>
                                         <td> <?=$dt->partner_type?></td>
                                         <td><?=$dt->contactperson?></td>
                                         <td><?=$dt->designation?></td>
                                         <td><?=$dt->meeting_type?></td>
                                         <td><?=$dt->current_status?></td>
                                         <td><?=$dt->live_loaction?></td>
                                         <td><?=$dt->mom_received?></td>
                                         <td><?=$dt->city?> - <?=$dt->state?></td>
                                         <td><?=$dt->last_remark?></td>
                                     </tr>
                                     <?php }?>
                                  </tbody>
                                </table>
