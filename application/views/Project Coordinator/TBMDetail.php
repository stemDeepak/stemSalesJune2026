                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="TBMD/1/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->ab?></a></td>
                                        <td><a href="TBMD/2/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->a?></a></td>
                                        <td><a href="TBMD/2/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->i?></a></td>
                                        <td><a href="TBMD/3/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->b?></a></td>
                                        <td><a href="TBMD/3/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->b?></a></td>
                                        <td><a href="TBMD/3/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->h?></a></td>
                                        <td><a href="TBMD/4/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->c?></a></td>
                                        <td><a href="/Menu/TBMDFRP/5/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->d?></a></td>
                                        <td><a href="TBMD/6/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->e?></a></td>
                                        <td><a href="TBMD/7/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->f?></a></td>
                                        <td><a href="TBMD/8/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->g?></a></td>
                                        <td><a href="TBMD/9/<?=$uid?>/<?=$date?>/<?=$date?>"><?=$tmd->k?></a></td>
                                    </tr>
                                    <?php }} ?>
                                  </tbody>
                                </table> 
