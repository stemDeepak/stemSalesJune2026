    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Task conversion Status Wise</h5></center><hr>
            ...
            datasets: [
                {
                    ...
                    data: [
                        ...
                        $task = $this->Menu_model->get_tasktypeconvstions($uid,$sd,$ed,$stid);
                        foreach($task as $ts){
                        ?>
                        <?=$ts->cont?>,
                        <?php }} ?>],
                ...
                <?php $sttatus = $this->Menu_model->get_status(); foreach($sttatus as $stt){ $sttid = $stt->id; ?>
                {
                    label: '<?=$stt->name?>',
                    ...
                    data: [
                        <?php 
                        $status = $this->Menu_model->get_status(); $i=1; foreach($status as $st){ $stid = $st->id;
                        $task = $this->Menu_model->get_tasktypeconvstionsbys($uid,$sd,$ed,$stid,$sttid);
                        foreach($task as $ts){
                        ?>
                        <?=$ts->cont?>,
                        <?php }} ?>],
