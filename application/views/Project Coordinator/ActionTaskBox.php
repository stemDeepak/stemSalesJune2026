    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12 p-3 text-center">
              <?php $acn = $this->Menu_model->get_actionbyid($ac);?>
              <center><h5>Completed <?=$acn[0]->name?> Task | Date : <?php echo $tdate="2023-08-08";?></h5></center><hr>
             <div class="row">
                 <?php
                 $mtdata = $this->Menu_model->get_bwdalltaskdbyad('3',$ac,$uid,$tdate,$tdate,0);
