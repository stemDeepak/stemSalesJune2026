    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12 p-3 text-center">
              <?php $stn1 = $this->Menu_model->get_statusbyid($st1);
                    if($stn1){$stn1=$stn1[0]->name;}else{$stn1='';}
                    $stn2 = $this->Menu_model->get_statusbyid($st2);
                    if($stn2){$stn2=$stn2[0]->name;}else{$stn2='';} ?>
                    
              <center><h5> Conversion Status <?=$stn1?> from to <?=$stn2?> | Date : <?php echo $tdate="2023-08-08";?></h5></center><hr>
             <div class="row">
                 <?php
                 $mtdata = $this->Menu_model->final_scon3($uid,$tdate,$tdate,$st1,$st2);
