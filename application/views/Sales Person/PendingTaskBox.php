    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Pending Task Date : <?php echo $tdate="2023-08-11";?></h5></center><hr>
             <div class="row">
                 <?php
                 $mtdata = $this->Menu_model->get_bwdalltaskdbyad('4','1',$uid,$tdate,$tdate,0);
                 ...
                 <div class="col-lg-3 col-md-6 col-sm p-3 <?=$action[0]->color?> rounded border">
                    ...
                    Plan to Current Time Diff<br><b><?=$timediff?></b><hr>
                 </div>
                 <?php } ?>
              </div>
          </div>
