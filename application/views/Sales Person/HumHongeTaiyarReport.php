                                    ...
                                    <table id="ourreview" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            ...
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'faq');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                          <td><?= $j++;?></td>
                                          <!--<td><?=$t->name?></td>-->
                                          <td><?=$udata['total'][$uid]?></td>
                                          <td><?=$udata['pst_approve'][$uid]?></td>
                                          <td><?=$udata['pst_reject'][$uid]?></td>
                                          <td><?=abs($udata['total'][$uid] - ($udata['pst_approve'][$uid] + $udata['pst_reject'][$uid]))?></td>
                                          <td><?=$udata['cluster_approve'][$uid]?></td>
                                          <td><?=$udata['cluster_reject'][$uid]?></td>
                                          <td><?=abs($udata['total'][$uid] - ($udata['cluster_approve'][$uid] + $udata['cluster_reject'][$uid]))?></td>
                                          <td><?=$udata['admin_approve'][$uid]?></td>
                                          <td><?=$udata['admin_reject'][$uid]?></td>
                                          <td><?=abs($udata['total'][$uid] - ($udata['admin_approve'][$uid] + $udata['admin_reject'][$uid]))?></td>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'salesppt');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview2" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'salespitch');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview3" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            //foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'presentation');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview4" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            //foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'proposal');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview5" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'email');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview6" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'whatsapp');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview7" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'regional-case-study');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview8" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'quarter1-ppt');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview9" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'annualreview');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview10" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'district-permission');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
                                  ...
                                  <div class="table-responsive">
                                    <table id="ourreview11" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php $j=1;
                                            // foreach($getbdteam as $t){
                                            $udata = $this->Menu_model->getResourceDetailsByUser($uid,'school');
                                            // echo "<pre>";
                                            // print_r($udata);
                                        ?>
                                        <tr>
...
<script>
 $( document ).ready(function() {
      ...
      $("#ourreview1").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview1_wrapper .col-md-6:eq(0)');
      
      $("#ourreview2").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview2_wrapper .col-md-6:eq(0)');
      
      $("#ourreview3").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview3_wrapper .col-md-6:eq(0)');
      
      $("#ourreview4").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview4_wrapper .col-md-6:eq(0)');
      
      $("#ourreview5").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview5_wrapper .col-md-6:eq(0)');
      
      $("#ourreview6").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview6_wrapper .col-md-6:eq(0)');
      
      $("#ourreview7").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview7_wrapper .col-md-6:eq(0)');
      
      $("#ourreview8").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview8_wrapper .col-md-6:eq(0)');
      
      $("#ourreview9").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview9_wrapper .col-md-6:eq(0)');
      
      $("#ourreview10").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview10_wrapper .col-md-6:eq(0)');
      
      $("#ourreview11").DataTable({
      "responsive": false, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print"]
      }).buttons().container().appendTo('#ourreview11_wrapper .col-md-6:eq(0)');
</script>
