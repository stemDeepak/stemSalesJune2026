    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>All Other Work on My Funnel Conversion</h5></center><hr>
            ...
            datasets: [
                {
                    ...
                    data: [
                        ...
                        $task = $this->Menu_model->get_tasktypeconvstionsbyother($uid,$sd,$ed,$stid);
                        foreach($task as $ts){
                        ?>
                        <?=$ts->cont?>,
                        <?php }} ?>],
                ...
                <?php  $sttatus = $this->Menu_model->get_status(); $i=1; foreach($sttatus as $stt){ $sttid = $stt->id;?>
                {
                    label: '<?=$stt->name?>',
                    ...
                    data: [
                        ...
                        $task = $this->Menu_model->get_tasktypeconvstionsbyothers($uid,$sd,$ed,$stid,$sttid);
                        foreach($task as $ts){
                        ?>
                        <?=$ts->cont?>,
                        <?php }} ?>],
