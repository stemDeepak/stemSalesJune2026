          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>E-Way Detail</h5><hr>
                       <div class="row">
                          <?php $i=1;$fpur = $this->Menu_model->get_fewaybill($project);
                          foreach($fpur as $pur){
                          ?>
                           <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                           <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                                <b><?=$i++?></b><hr>
                                Info Date<br><b><?=$this->Menu_model->get_dformat($pur->sdatet)?></b><hr>
                              
                              <object data="https://stemfactory.in/<?=$pur->ewaybill?>" type="application/pdf" width="100%" height="500">
                                <p>Your browser does not support PDF embedding. You can download the PDF <a href="https://stemfactory.in/<?=$pur->ewaybill?>">here</a>.</p>
                              </object><hr>
