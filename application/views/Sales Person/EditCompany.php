      ...
      <div class="container-fluid">
       <div class="row p-3">
          <div class="col-sm col-md-12 col-lg-12">
            <!-- Profile Image -->
            <div class="card card-primary card-outline col-lg-4 col-sm m-auto">
              <div class="card-body box-profile">
                <hr>
                <form action="<?=base_url();?>Menu/updatecompany" method="post">
                    <input type="hidden" name="cid" value="">
                <?php foreach($cc as $c){?>
                <center><h3><?=$c->compname?></h3></center>
                <?php } ?>
                            ...
                            <input type="text"  class="form-control"  name="budget" value="<?=$c->budget?>">
                            <select name="partnertype" id="partnertype" required class="form-control">
                                <?php 
                                $partnerype = $this->Menu_model->get_partner();
                                foreach($partnerype as $pt){?>
