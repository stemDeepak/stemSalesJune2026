                            ...
                            <div class="was-validated">
                                ...
                                <div class="card p-2">
                                    ...
                                    <?php $sd = '2023-04-01';
                                          $ed = '2024-03-31';
                                        //   var_dump($uid); exit;
                                          $scname=$this->Menu_model->final_scon1($uid,$sd,$ed,0);
                                    ?>
...
<!--                                                    </tr>-->
                                ...
                                <div class="card p-2">
                                    ...
                                    // var_dump($action_ct);
                                    ?>
                                    <div class='form-control'>Task Performed :</div><br>  
                                    <div class="col-sm col-lg-12">
                                        <div class="table-responsive">
                                            <table id="" class="table table-striped table-bordered" cellspacing="0" width="">
                                                <thead>
                            ...
                            <div class="card p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="hideoncompanykeep">
                                        ...
                                        <div class="form-group">
                                            <label>Current year Status <span>(Previous Year Status : <?=$this->Menu_model->get_statusbyid($init_data->cstatus)[0]->name?>)</span></label>
                                            <select class="form-control" id="statusid" name="cstatusid" onchange="generateTable()" required>
                                        ...
                                        <div class="form-group">
                                            <label>Is the location of this company is Right?<span>(Previous Location - <?=$company->address?>)</span></label>
                                            <select class="form-control" id="location" name="clocation" required>
                                                <option value="yes">Yes</option>
                                                <option value="no">No</option>
                                            </select><br>
                                            <div class="newLocation">
                                                <label>Enter Updated Location</label>
                                        ...
                                        <div class="form-group">
                                            <label>Top Spender For this Year?</label>
                                        ...
                                        <div class="form-group">
                                            <label>Is partnership type right?<span>(Previous Partner Type : <?=$this->Menu_model->get_partnerbyid($company->partnerType_id)[0]->name?>)</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="noschool" id="noschool" placeholder="NO of School"required>
                                        </div>
                                        <div class="form-group">
