...
Is the task planned and frequency correct?</textarea>
                            ...
                            <div class="card p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="hideoncompanykeep">
                                        ...
                                        <select class="form-control" name="selectCluster" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="intervention" id="intervention">
                                                ...
                                                <?php } ?>
                                                <?php if(isset($clusteradmin)){
                                                foreach($clusteradmin as $c){ ?>
                                        ...
                                        <div class="form-group">
                                            <label>What Support You Required In Detail?</label>
                        ...
                        <center><button type="submit" class="btn btn-success" onClick="this.form.submit(); this.disabled=true; this.value='Sending…';" id="submitButton">SUBMIT</button><br></center>
                    </form>  
                </div>
            </div>
        </section>
