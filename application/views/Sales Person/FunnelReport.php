...
<div class="container-fluid p-3">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Funnel Report</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php foreach($mdata as $dt){if($dt->name==$user['name']){
                                        ?>
                                    <tr>
                                        <td><?=$dt->name?></td>
                                        <td><?=$dt->totaltaks?></td>
                                        ...
                                        <td><?=$dt->reachout?></td>
                                        <td><?=$dt->tantative?></td>
                                        <td><?=$dt->will_do_later?></td>
                                        <td><?=$dt->not_interested?></td>
                                        <td><?=$dt->positive?></td>
                                        <td><?=$dt->very_positive?></td>
                                        <td><?=$dt->closure?></td>
                                     </tr>
                                     <?php }}?>
                                  </tbody>
