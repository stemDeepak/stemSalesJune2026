          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>Purchase Detail</h5><hr>
                       <div class="row">
                          <?php $fpur = $this->Menu_model->get_fpur($project);
                          foreach($fpur as $pur){
                          ?>
                           
                           <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                           <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                                Material Name<br><b><?=$pur->material_name?></b><hr>
                                QTY<br><b><?=$pur->material_qty?> <?=$pur->unit?></b><hr>
                                Vander Name<br><b><?=$pur->vander_name?></b><hr>
                                PO NO<br><b><?=$pur->pono?></b><hr>
                                Initiated Date<br><b><?=$this->Menu_model->get_dformat($pur->sdate)?></b><hr>
                                Plan Date<br><b><?=$this->Menu_model->get_dformat($pur->plandt)?></b><hr>
                                Target Date<br><b><?=$this->Menu_model->get_dformat($pur->targetdt)?></b><hr>
                                PO Date<br><b><?=$this->Menu_model->get_dformat($pur->gpodate)?></b><hr>
                                Payment Date<br><b><?=$this->Menu_model->get_dformat($pur->paymetdate)?></b><hr>
                                <b><img class="img-thumbnail" src="https://stemfactory.in/<?=$pur->matimg?>" width="100%"></b><hr>
                                <b><img class="img-thumbnail" src="https://stemfactory.in/<?=$pur->matdimg?>" width="100%"></b><hr>
                                <div class="rounded-circle <?=$tcolor?>" style="position: absolute;bottom: -10px; left: 40%; transform: translateX(-50%); width: 20px; height: 20px;"></div>
                                <div class="rounded-circle bg-danger" style="position: absolute;bottom: -10px; left: 60%; transform: translateX(-50%); width: 20px; height: 20px;"></div>
                           </div>
                           </div>
