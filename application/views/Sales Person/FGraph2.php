  ...
  <script type="text/javascript">
        ...
        function drawChart12() {
          ...
          <?php
            ...
            foreach ($city as $ci) {
            $statusName = $ci->city . " (" . $ci->cont . ")";
            echo "data.addRow(['$statusName', $ci->cont, '$ci->cityid', '$uid']);";
          }
          ?>
          ...
          google.visualization.events.addListener(chart, 'select', function() {
            ...
            if (selection) {
              ...
              window.location.href = '<?=base_url();?>Menu/FGraph2/' + cityid;
            }
          });
          ...
          <div class="card col-12  p-3 text-center">
              ...
              <div class="container-fluid card p-5" id="data-container">
                <div class="row text-center" id="grid-view">
                    ...
                    <?php 
                         $mdata = $this->Menu_model->get_fannalbycode($uid,$cityid,$code);
                         foreach($mdata as $dt){
                         $cid = $dt->cmpid_id;
                ...
                <div id="tabular-view" style="display: none;">
                    ...
                    <?php
                      $city = $this->Menu_model->get_fannalcitywise($uid);
                        foreach ($city as $ci) {?>
                      <b><a href="<?=base_url();?>Menu/FGraph2/<?=$ci->cityid?>"><?=$ci->city?> - <?=$ci->cont?></a></b><hr>
                      <?php } ?>
                      <b><a href="<?=base_url();?>Menu/FGraph2/0/">View All</a></b>
                      </div>
                </div>  
