                  ...
                  <center><h3>BD Name: <?=$annualr1[0]->uname?></h3></center>
                            <div class="row">
                                <div class="col-12 p-2">
                                    <lable><h4>Meeting Detail</h4></lable>
                                    <table class="table">
                                        <tr>
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Districts Travelled</h4></lable>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Potential district/ Top district of respective region</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Aspirational district of your respective region</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Top spender companies</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Top Spender RP Companies Completed</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Connect Detail</h4></lable>
                                    <table class="table">
                                        <tr>
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Current funnel report (in separate format)</h4></lable>
                                    <table class="table">
                                        <tr>
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Model school visit/ readyness</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Client visit to model school</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    ...
                                    <div class="row">
                                        <?php for($i=0;$i<$l;$i++){?>
                                        <div class="col-3 p-1">
                                            <b><?=$i?>. <?=$cdcompany[$i]?> (<?php if($i<$m){echo $cdschool[$i];} ?>) (<?php if($i<$n){echo $cdrevenue[$i];} ?>)</b>
                                        </div>
                                        <?php } ?>     
                                    </div>
                                </div>
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Active Key client for FY 2023-24</h4>
                                    <?php 
                                ...
                                <div class="col-12 p-2">
                                    <lable><h4>Active Key client for FY 2023-24 (Q1)</h4>
                                    <?php 
                            ...
                            <lable><h4>Achievement in the last FY:</h4><?=$annualr3[0]->Achievement?></lable>
                        </div>
                    </div>
            </div>
