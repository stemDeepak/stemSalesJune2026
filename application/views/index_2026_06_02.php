...
<body class="hold-transition login-page" style="height: 100vh!important;">
    ...
    <img src="https://stemapp.in/uploads/profile_pics/astronaut1.png" class="astronaut" id="astronaut1" width="100" height="100" alt="Astronaut 1" />
    <img src="https://stemapp.in/uploads/profile_pics/astronaut2.png" class="astronaut" id="astronaut2" width="100" height="100" alt="Astronaut 2" />
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let posX1 = Math.random() * (window.innerWidth - 100);
            let posY1 = Math.random() * (window.innerHeight - 100);
            let posX2 = Math.random() * (window.innerWidth - 100);
            let posY2 = Math.random() * (window.innerHeight - 100);
            let speedX1 = (Math.random() - 0.5) * 4;
            let speedY1 = (Math.random() - 0.5) * 4;
            let speedX2 = (Math.random() - 0.5) * 4;
            let speedY2 = (Math.random() - 0.5) * 4;
            let rotation1 = 0;
            let rotation2 = 0;
            let rotationSpeed1 = (Math.random() - 0.5) * 5;
            let rotationSpeed2 = (Math.random() - 0.5) * 5;
            let together = false;

            function updateAstronauts() {
                const distance = Math.sqrt(Math.pow(posX2 - posX1, 2) + Math.pow(posY2 - posY1, 2));
                if (distance < 50 && !together) {
                    together = true;
                }
                if (together) {
                    posX1 += speedX1;
                    ...
                    posY2 = posY1;
                    if (
                        posX1 <= 0 || posX1 >= window.innerWidth - 100 ||
                        posY1 <= 0 || posY1 >= window.innerHeight - 100
                    ) {
                        together = false;
                        posX2 = posX1 + (Math.random() > 0.5 ? 50 : -50);
                        posY2 = posY1 + (Math.random() > 0.5 ? 50 : -50);
                        speedX1 = (Math.random() - 0.5) * 4;
                        speedY1 = (Math.random() - 0.5) * 4;
                        speedX2 = (Math.random() - 0.5) * 4;
                        speedY2 = (Math.random() - 0.5) * 4;
                    }
                } else {
                    posX1 += speedX1;
                    posY1 += speedY1;
                    posX2 += speedX2;
                    posY2 += speedY2;
                    if (posX1 <= 0 || posX1 >= window.innerWidth - 100) speedX1 = -speedX1;
                    if (posY1 <= 0 || posY1 >= window.innerHeight - 100) speedY1 = -speedY1;
                    if (posX2 <= 0 || posX2 >= window.innerWidth - 100) speedX2 = -speedX2;
                    if (posY2 <= 0 || posY2 >= window.innerHeight - 100) speedY2 = -speedY2;
                }
                rotation1 += rotationSpeed1;
                rotation2 += rotationSpeed2;
                astronaut1.style.left = `${posX1}px`;
                astronaut1.style.top = `${posY1}px`;
                astronaut1.style.transform = `rotate(${rotation1}deg)`;
                astronaut2.style.left = `${posX2}px`;
                astronaut2.style.top = `${posY2}px`;
                astronaut2.style.transform = `rotate(${rotation2}deg)`;
                requestAnimationFrame(updateAstronauts);
            }
            astronaut1.style.left = `${posX1}px`;
            astronaut1.style.top = `${posY1}px`;
            astronaut2.style.left = `${posX2}px`;
