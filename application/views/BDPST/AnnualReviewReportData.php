                  ...
                  <div class="card-body box-profile">
                    ...
                    <form  action="<?=base_url();?>Menu/startAnnualReview" method="post">
                      ...
                      <div class="was-validated">
                            ...
                            <div class="ApprovedStatus">
                              ...
                              <div class="table-responsive">
                                ...
                                <?php $j=1; 
                                  ...
                                  $revTarget = $this->Menu_model->companyannualreviewtarget($a->company_id);
                                   // echo "<pre>";
                                  // print_r($revTarget);
                                  // die;
                                  ...
                                  ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?=  $revTarget->focuspositive ?></td>
                                      <td><?=  $revTarget->focusfunnel ?></td>
                                      <td><?=  $revTarget->topspender ?></td>
                                      
                                      <td><?=  $revTarget->upsell ?></td>
                                      <td><?php
                        ...
                        <div class="bg-warning text-center mt-2 mb-2">
                        ...
                        <div class="btn btn-primary col-md-12 col-lg-12 mt-2 d-flex justify-content-between align-items-center" data-toggle="collapse" href="#collapseExample<?=$k?>" role="button" aria-expanded="false" aria-controls="collapseExample<?=$k?>">
                          <?= $k ?> - <?= $bdteam->name .' - '.$bdteamid ?> - Annual Company Report: 
                          <!-- <div>-->
                          <!--    <a href="<?=base_url();?>Menu/approveAnnualReview/<?=$a->id?>/Approve" class="btn btn-success mr-2">Approve</a>-->
                          <!--    <a href="<?=base_url();?>Menu/approveAnnualReview/<?=$a->id?>/Reject" class="btn btn-danger">Reject</a>-->
                          <!--</div>-->
