          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>Box MS Dispatch Detail</h5><hr>
                       <div class="row">
                          <?php $i=1;$fpur = $this->Menu_model->get_fboxmsd($project);
                          foreach($fpur as $pur){
                          ?>
                           <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                           <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                                <b><?=$i++?></b><hr>
                                Dispatch Date<br><b><?=$pur->dispatchdt?></b><hr>
                                Box Weight<br><b><?=$pur->weighkg?></b><hr>
                                Pack By<br><b>Sayali</b><hr>
                                <b><img class="img-thumbnail" src="https://stemfactory.in/<?=$pur->weighvideo?>" width="100%"></b><hr>
