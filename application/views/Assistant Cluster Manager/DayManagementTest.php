              ...
              <div class="card-body" id="mainboxAutoTask1">
                ...
                <marquee class="p-2 mt-1" width="100%"  onMouseOver="this.stop()" onMouseOut="this.start()" behavior="left" bgcolor="pink">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" id="start-time" name="startautotasktime" class="form-control" value="16:00" required>
                  </div>
...
<div class="row">
                ...
                <marquee class="p-2 mt-1" width="100%"  onMouseOver="this.stop()" onMouseOut="this.start()" behavior="left" bgcolor="pink">
                  ...
                  <div class="form-group">
                    <label for="end-time">Enter End Time</label>
                    <input type="time" id="end-time" name="endautotasktime" class="form-control is-invalid" value="17:30" required>
                  </div>
                  </div>
                  <div class="col-sm-6 col-sm mt-3">
                  <marquee class="p-2 mt-1" width="100%"  onMouseOver="this.stop()" onMouseOut="this.start()" behavior="left" bgcolor="pink">
