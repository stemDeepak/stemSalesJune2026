            ...
            <div class="row">
              ...
              <input type="hidden" value="<?= $oldPendTaskcnt?>" name="taskcnt">
               <div class="row">
                <div class="col-md-12">
                <?php 
                $checktodaysPlannerStartOrNot    = $this->Menu_model->CheckTodaysPlannerStartTimeOnYesterDayDate($uid,$adate);
            ...
            <div class="card container-fluid" id="backgroundchange">
              ...
              <div class="row">
                ...
                // }
                 ...
                 if($emergencytaskcnt < $emergencytaskcntbreak){ ?>
                      <div class="form-check">
                        <label class="form-check-label custom-radio-label">
                      ...
                      */ ?>
                      ...
                      <?php }elseif($mandatory_task_cnt > 0){ ?>
                          <div class="form-check">
                              <label class="form-check-label custom-radio-label">
...
$plandate = date("Y-m-d");
                     ...
                     <?php }else{
                        ...
                        // $statusnochangecmp              = [];
                        // $statusnochangecmp_wdl_nl       = [];
                        $statusnochangecmpcnt           = sizeof($statusnochangecmp);
                        $statusnochangecmp_wdl_nl_cnt   = sizeof($statusnochangecmp_wdl_nl);

                        // $status_nochangecnt = 0;
                     ...
                     <div class="form-check" id="review_planning_filter" title="New Review Planning refers to the initial setup and scheduling of a fresh evaluation or assessment process. It includes defining objectives, selecting review criteria, setting timelines, and assigning responsibilities. This planning phase ensures the review is structured, goal-oriented, and aligned with current priorities or performance improvement initiatives.">
                      ...
                      <div class="form-check" id="quater_strategy">
                        <label class="form-check-label custom-radio-label">
                          <input type="radio" class="form-check-input" name="optradio" value="Quater Strategy"> <span>Quater Strategy</span> 
                        </label>
                      </div>

                      <div class="form-check" id="create_bdrequest_filter" title="Create BD Request refers to initiating a formal request for Business Development (BD) support or action. This may include tasks like lead follow-up, client engagement, proposal submission, or partnership exploration. Creating a BD request helps streamline communication, delegate responsibilities, and ensure timely execution of business growth activities.">
                        <label class="form-check-label custom-radio-label">
                    ...
                    <form action="<?=base_url();?>/Menu/PlanningForReview" method="post" id="create-plan-form">
                      <div class="was-validated">
                        <div class="form-group">
                          ...
                          <?php }?>
                          <?php if($type_id ==13 || $type_id ==4 || $type_id ==24){ ?>
                          <div class="mt-0">
                            <lable>Select User</lable>
                            <select class="form-control" name="bdid" id="review_bd" required="">
                              <option value="<?=$uid?>"><?=$user['name']?></option>
    ...
    <script type='text/javascript'>
      ...
      if(val=='Compnay Name'){
          ...
          if(userslcttype == 13 || userslcttype == 24){
            $('#selectcompanyname').hide();
            $("#selectstatus").hide();
