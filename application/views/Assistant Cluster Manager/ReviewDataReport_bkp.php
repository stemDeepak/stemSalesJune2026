...
<div class="form-group">
                <label for="sdate">Review Start Date</label>
<input type="date" name="sdate" class="form-control" class="mr-2" value="<?=$sd?>">
</div>
<div class="form-group">
           <label for="sdate">Review End Date</label>
<input type="date" name="edate" class="form-control" class="mr-2" value="<?=$ed?>">
</div>
<div class="form-group">
                <label for="sdate">Select User</label>            <select name="pstname" class="form-control" id="adminvalue">
