          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                           <h5>Join Call</h5><hr>
                           <?php $data = $this->Menu_model->get_htprocess($cid,'6');?>
                           Started<br><b><?=$data[0]->startt?></b><hr>
                           Cloesed<br><b><?=$data[0]->closet?></b><hr>
                           Time Diff<br><b><?=$this->Menu_model->timediff($data[0]->closet,$data[0]->startt)?></b><hr>
                           Attended by<br><b>Attended by</b><hr>
                           Final Remark<br><b><?=$data[0]->cremark?></b><hr>
                           Recording Link<br><b>Link</b><hr>
