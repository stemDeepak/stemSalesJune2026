          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>School Report</h5><hr>
                       <div class="row">
                       <?php $data = $this->Menu_model->get_htprocess($cid,'44'); $i=1; foreach($data as $da){?>
                       <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                       
                       
                       <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                           (<?=$i++?>) Sachool Name<br><b><?=$da->sname?></b><hr>
                           Address<br><b><?=$da->saddress?>, <?=$da->scity?>, <?=$da->sstate?></b><hr>
                           PIA Name<br><b><?=$da->piname?></b><hr>
                           IMP Name<br><b><?=$da->insname?></b><hr>
                           Assign date<br><b><?php if($da->tassdt){echo $this->Menu_model->get_dformat($da->tassdt);}else{echo 'Not Assign';}?></b><hr>
                           Plan date<br><b><?php if($da->tplandt){echo $this->Menu_model->get_dformat($da->tplandt);}else{echo 'Not Plan';}?></b><hr>
                           Completed date<br><b><?php if($da->tdonedt){echo $this->Menu_model->get_dformat($da->tdonedt);}else{echo 'Not Completed';}?></b><hr>
                           Remark<br><b><?=$da->tremark?></b><hr>
                           <br><b><?php if($da->tassdt){?><a href="https://stemoppapp.in/<?=$da->tfilepath?>">Report Download<?php }else{echo 'Report Not Uploded';}?> </b><hr>
