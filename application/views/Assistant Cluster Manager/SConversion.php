                        ...
                        <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <?php 
                                    $scname=$this->Menu_model->final_scon1_Cluster($uid,$sd,$ed,0); 
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="FinalSConversionByClusterTeam/<?=$uid?>/<?=$sd?>/<?=$ed?>/<?=$fsid?>/<?=$ssid?>">
                                            <?=$this->Menu_model->final_scon2inCluster($uid,$sd,$ed,0,$fsid,$ssid);?>
                                        </a>
                                    </td>
