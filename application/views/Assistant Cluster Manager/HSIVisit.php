          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>School Installation Visit</h5><hr>
                       <div class="row">
                       <?php $data = $this->Menu_model->get_htprocess($cid,'43'); $i=1; foreach($data as $da){?>
                       <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                       
                       
                       <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                           (<?=$i++?>) Sachool Name<br><b><?=$da->sname?></b><hr>
                           <a href="<?=base_url();?>Menu/HSIVDetail/<?=$code?>/<?=$cid?>/<?=$da->tid?>/<?=$da->sid?>">
                           Address<br><b><?=$da->saddress?>, <?=$da->scity?>, <?=$da->sstate?></b><hr>
                           PIA Name<br><b><?=$da->piname?></b><hr>
                           IMP Name<br><b><?=$da->insname?></b><hr>
                           Assign date<br><b><?php if($da->tassdt){echo $this->Menu_model->get_dformat($da->tassdt);}else{echo 'NO DATA';}?></b><hr>
                           Plan date<br><b><?php if($da->tplandt){echo $this->Menu_model->get_dformat($da->tplandt);}else{echo 'NO DATA';}?></b><hr>
                           Completed date<br><b><?php if($da->tdonedt){echo $this->Menu_model->get_dformat($da->tdonedt);}else{echo 'NO DATA';}?></b><hr>
