                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><?=$dt->name?></td>
                                      <td> <a target="_blank" class="btn btn-primary" href="<?=base_url().'Management/TotalMomData/'.$dt->user_id.'/'.$cdate;?>"> <?=$mom_Data_total_cnt ?></a></td>
                                      <td> <a target="_blank" class="btn btn-primary" href="<?=base_url().'Management/MomData/'.$dt->user_id.'/'.$cdate;?>"> <?=$mom_Datacnt ?></a></td>
                                      <td> <a target="_blank" class="btn btn-primary" href="<?=base_url().'Management/TotalApproveMomData/'.$dt->user_id.'/'.$cdate;?>"> <?=$mom_Data_appr_cnt ?></a></td>
                                      <td> <a target="_blank" class="btn btn-primary" href="<?=base_url().'Management/MomDataReject/'.$dt->user_id.'/'.$cdate;?>"> <?=$mom_Data_Reject_cnt ?></a></td>
                                    </tr>
                                    <?php $i++;} ?>
                                  </tbody>
                                </table>
