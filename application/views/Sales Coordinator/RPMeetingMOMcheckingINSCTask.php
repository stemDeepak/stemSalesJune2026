                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <?php if($value->total_NO_RP > 0){ ?>
                                        <a target="_BLANK" class="text-center" href="<?=base_url().'Menu/CheckDataUsingScTask/'.$value->user_id.'/'.$trrdate; ?>/total_NO_RP">
                                          <small><span> 👁️</span></small>
                                        </a>
                                     <?php } ?>
                                  </td>
                                    ...
                                    <?php if($value->total_Only_Got_Details > 0){ ?>
                                        <a target="_BLANK" class="text-center" href="<?=base_url().'Menu/CheckDataUsingScTask/'.$value->user_id.'/'.$trrdate; ?>/total_Only_Got_Details">
                                          <small><span> 👁️</span></small>
                                        </a>
                                     <?php } ?>
                                  </td>
                                    ...
                                    <?php if($value->total_mom > 0){ ?>
                                        <a target="_BLANK" class="text-center" href="<?=base_url().'Menu/CheckDataUsingScTask/'.$value->user_id.'/'.$trrdate; ?>/total_mom">
                                          <small><span> 👁️</span></small>
                                        </a>
                                     <?php } ?>
                                  </td>
                                    ...
                                    <?php if($value->total_mom_Done > 0){ ?>
                                        <a target="_BLANK" class="text-center" href="<?=base_url().'Menu/CheckDataUsingScTask/'.$value->user_id.'/'.$trrdate; ?>/total_mom_Done">
                                          <small><span> 👁️</span></small>
                                        </a>
                                     <?php } ?>
                                  </td>
                                    ...
                                    <?php if($value->total_mom_Pending > 0){ ?>
                                        <a target="_BLANK" class="text-center" href="<?=base_url().'Menu/CheckDataUsingScTask/'.$value->user_id.'/'.$trrdate; ?>/total_mom_Pending">
                                          <small><span> 👁️</span></small>
                                        </a>
                                     <?php } ?>
                                  </td>
