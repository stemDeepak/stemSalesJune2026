                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($mdata as $dt){
                                            ...
                                            $topspender = $init[0]->topspender;
                                            $upsell_client = $init[0]->upsell_client;
                                            $focus_funnel = $init[0]->focus_funnel;
                                            $pkclient = $init[0]->pkclient;
                                            $priorityc = $init[0]->priorityc;
                                    ...
                                    <tr>
                                         ...
                                         <td><?php if(isset($cd[0]->partnerType_id)){
                                          ...
                                          $partnerData =  $this->Menu_model->get_partnerbyid($cd[0]->partnerType_id);
                                          $partnerDataname = $partnerData[0]->name;
                                          echo $partnerDataname;
                                          
                                          }?></td>
                                         <td><?php if(isset($focus_funnel)){echo $focus_funnel;}?></td>
                                         <td><?php if(isset($upsell_client)){echo $upsell_client;}?></td>
                                         <td><?=$contactperson?></td>
                                         <td><?=$phoneno?></td>
                                         <td><?=$emailid?></td>
                                         <td><?=$designation?></td>
