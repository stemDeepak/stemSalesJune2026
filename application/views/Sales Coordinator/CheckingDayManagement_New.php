                                          ...
                                          <table id="TodayMorningTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead class="thead-dark">
                                                <tr>
                                                    ...
                                                    <th>Todays Pending Task Plan Request</th>
                                                  ...
                                                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                                                   ...
                                                   <!-- Work FROM TD START-->
                                                    ...
                                                    <td data-question="Planner requested correctly" data-userid="<?= $data->user_id; ?>" data-period="Mornings" data-cdate="<?= $cdate; ?>">
                                                      ...
                                                      <td data-question="Pending Task Planner requested correctly" data-userid="<?= $data->user_id; ?>" data-period="Mornings" data-cdate="<?= $cdate; ?>">
                                                        <?php 
                                                        
                                                        if($data->pending_task_planner_request =='Yes'){ ?>
                                                            
                                                            <b>Pending task Planner Request At : </b><?= $data->pending_task_planner_request ?> <hr>
                                                            <b>Requested At : </b><?= $data->planner_request_date ?> <hr>
                                                            <b>Task Request : </b><?= $data->task_count ?> <hr>
                                                            <b>Request Reamarks : </b><?= $data->request_remarks ?> <hr>
                                                            <b>Approval Status : </b><?php if($data->planner_request_approved_status == 1){
                                                                echo "Approved";
                                                            }else{
                                                                echo "Pending";
                                                            } ?> <hr>

                                                            <b>Pending Planner Approved at : </b> <?= $data->planner_request_approved_date ?> <hr>
                                                            <b>Pending Planner Approved by : </b> <?= $data->pending_planner_request_apr_by ?>

                                                        <?php }else{
                                                            echo '<p class="font-weight-bold text-success">No Pending Task Planner Request..!!</p>';

                                                            
                                                        }
                                                        ?>
                                                        <hr>
                                                        <p class="question">Pending Task Planner requested correctly?</p>
                                                        <?php 

                                                            $chkStarRating = $this->Management_model->CheckStarRatingsExistorNot_New($teamuid,$cdate,'Pending Task Planner requested correctly','Mornings');
                                                ...
                                                ?>
                                                     <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                                                        ...
                                                        <td data-question="The Day Ended at a good time" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            ...
                                                            $sdate->modify('-1 day');
                                                            $previousDateDemo = $sdate->format('Y-m-d');
                                                        ...
                                                        <td data-question="Autotask added on correct time" data-userid="<?= $data->user_id;?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            ...
                                                            <?php
                                                                ...
                                                                if (sizeof($chkStarRating) == 0) { ?> 
                                                                    <div class="rating">
                                                                        <input type="radio" name="rat7_<?= $data->user_id; ?>" value="5" id="105_<?= $data->user_id; ?>"><label for="105_<?= $data->user_id; ?>">☆</label>
                                                                        <input type="radio" name="rat7_<?= $data->user_id; ?>" value="4" id="104_<?= $data->user_id; ?>"><label for="104_<?= $data->user_id; ?>">☆</label>
                                                                        <input type="radio" name="rat7_<?= $data->user_id; ?>" value="3" id="103_<?= $data->user_id; ?>"><label for="103_<?= $data->user_id; ?>">☆</label>
                                                                        <input type="radio" name="rat7_<?= $data->user_id; ?>" value="2" id="102_<?= $data->user_id; ?>"><label for="102_<?= $data->user_id; ?>">☆</label>
                                                                        <input type="radio" name="rat7_<?= $data->user_id; ?>" value="1" id="101_<?= $data->user_id; ?>"><label for="101_<?= $data->user_id; ?>">☆</label>
                                                                    </div> 
                                                                <?php } else {
                                                                foreach ($chkStarRating as $star) {
                                                                    // var_dump($chkStarRating);die;
                                                        ...
                                                        <td data-question="total time taken to plan planner" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            ...
                                                            <?php 
                                                            $planSessionData    = $this->Menu_model->GetPlannerSessionByUidAndDate($teamuid,$previousDate);
                                                            $planSessionmin     = $this->Menu_model->TodaysTotalsPlannerSessioninMinuteByUidAndDate($teamuid,$previousDate);
                                                            $totalttaskdata     = $this->Menu_model->getTotalUserTaskDetailsOnPlanner($teamuid,date("Y-m-d"));
                                                            ...
                                                            <b>Planner Session : </b>
                                                                ...
                                                                echo "No Planning on Same Days";
                                                                }else{
                                                                echo (sizeof($planSessionData) == 0) ? 1 : sizeof($planSessionData);
                                                                }
                                                                ?>
                                                            <hr>
                                                            <p class="question"><b>Time taken to plan the planner.??</b></p>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        $averageTimePerTask_message = "<b>The average time per task is : </b> $averageTimePerTask";
                                                                    ...
                                                                    ?>
                                                                    <hr>
                                                                    <p class="question"><b>Total Task Plan: </b> <?=$totalttaskdataCnt?> Task</p>
                                                                   
                                                                    <hr>
                                                                    <?=$averageTimePerTask_message?>
                                                        ...
                                                        <td data-question="Day End Image is Good" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            <?php
                                                            if(!empty($data->user_close_image) || !is_null($data->user_close_image)) {?>
                                                        ...
                                                        <td data-question="Was day ended on good time" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            <?php if (isset($data->close_day_request_Remark)) { ?>
                                                                <b>Close Day Request Remark : </b><?= $data->close_day_request_Remark ?>
                                                                <hr>
                                                                <b>User Remark : </b> <?= $data->close_day_req_remarks ?>
                                                                <hr>
                                                                <b>Approved Status : </b>  <?= $data->close_day_approved_status ?>
                                                                <hr>
                                                                <b>Approved Reamrks : </b> <?= $data->close_day_approved_remarks ?>
                                                        ...
                                                        <td data-question="Day End Location as per Plan" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Evening" data-cdate="<?= $cdate; ?>">
                                                            ...
                                                            $clongitude = $data->user_end_long;

                                                            $user_start_lat = $data->user_start_lat;
                                                            $user_start_long = $data->user_start_long;

                                                            $user_close_time = $data->user_close_time;

                                                            if((empty($clatitude) || is_null($clatitude)) && (!empty($user_close_time))){
                                                                $clatitude = $user_start_lat;
                                                                $clongitude = $user_start_long;
                                                            }
                                                            ...
                                                            <?php } else { ?>
                                                                <span class="text-danger p-1 font-weight-bold"> Not closed same days..!!</span>
                                                            <?php } ?>
                                                ...
                                                ?>
                                                   <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                                                        ...
                                                        <td data-question="Yesterday Total Plan Task is Good" data-userid="<?= $data->user_id; ?>" data-period="Yesterday Task" data-cdate="<?= $cdate; ?>">
                                                            <?php 
                                                            $dayData = $this->Management_model->CheckingYesterDayTaskStatus($teamuid,$previousDate);
