                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <?php $scname=$this->Menu_model->final_scon1($admid,$sd,$ed,0); foreach($scname as $sc1){?>
                                            <th><?=$sc1->scname?></th>
                                            <?php } ?>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><a href="FinalBDSC/<?=$sd?>/<?=$ed?>"><?=$sd?> to <?=$ed?></a></td>
                                        ...
                                        <td>
                                            <a href="FinalSConversion/<?=$admid?>/<?=$sd?>/<?=$ed?>/<?=$fsid?>/<?=$ssid?>">
                                            <?=$this->Menu_model->final_scon2($admid,$sd,$ed,0,$fsid,$ssid);?>
                                            </a>
                                        </td>        
