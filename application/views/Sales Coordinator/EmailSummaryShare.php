                              ...
                              <form action="<?=base_url().'Menu/UpdateScTaskWithIdWithRemarksEmailSummaryShare'?>" method="POST" enctype="multipart/form-data">
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <th>Type Name</th>
                                    <th>Userworkfrom</th>
                                    <th>Total Email Task</th>
                                    <th>Complete Email Task</th>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <input type="text" class="form-control" name="total_email_task[]" value="<?= $value->total_email_task; ?>" readonly>
                                    </td>
                                    <td>
                                      <input type="text" class="form-control" name="complete_email_task[]" value="<?= $value->complete_email_task; ?>" readonly>  
                                    </td>
                                    <td>
                                      <input type="text" class="form-control" name="pending_email_task[]" value="<?= $value->pending_email_task; ?>" readonly>  
                                    </td>
                                    <td>
                                      <input type="number" class="form-control" name="mark_in_cc[]" placeholder="Number of CC Email" required >  
                                    </td>
                                  </tr>
                                  <?php $i++; endforeach; ?>
                                  </tbody>
