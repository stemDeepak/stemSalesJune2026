...
<?php
        ...
        foreach ($totalMeetingsUserByDatas as $item) {
            ...
            foreach ($item as $key => $value) {
                ...
                if($key == 'meetings_id' || $key == 'nextCFID' || $key =='assignedto_id' || $key == 'actiontype_id' || $key == 'filter_by' || $key == 'task_user_id' || $key == 'task_id' || $key == 'cid_id' || $key == 'initphoto' || $key == 'cphoto' || $key == 'actontaken' || $key == 'purpose_achieved'){
                    continue;
                }
...
<hr>
       ...
       <?php  echo '<h2>Photos</h2><hr/>'; ?> 
        <div class="row">
            <div class="col-md-6 text-center">
                <div class="card" style="align-items: center;">
                    <h4>Start Photo</h4>
                    <?php echo '<img src="' . base_url().'uploads/day/'.htmlspecialchars($item->initphoto) . '" width="200px" alt="Start Photo" class="img-fluid mb-3">'; ?>
                </div>
            </div>
            <div class="col-md-6 text-center">
                <div class="card" style="align-items: center;">
                    <h4>Closed Photo</h4>
                    <?php echo '<img src="' . base_url().htmlspecialchars($item->cphoto) . '" width="200px" alt="Closing Photo" class="img-fluid">'; ?>
                </div>
            </div>
            <div class="col-md-12 text-center">
            <br>
