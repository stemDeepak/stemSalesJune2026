  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <?php
                                    if($data->status == 'pending_manager' || $data->update_status == 'pending_manager'){ ?>
                                    
                                    <div>
                                      <p><a href="<?=base_url();?>Menu/leaveAction/approved_manager/<?= $data->id?>/<?=$data->leave_end_request?>" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                                      <p><button type="button" class="btn btn-primary" onclick="Reject(<?= $data->id?>,<?=$data->leave_end_request?>)">Reject</button></p>
                                    </div>
                                    
                                    <?php }else if(($data->status == 'pending_admin' && $data->update_status == null) || ($data->update_status == 'pending_admin')){ ?>
        ...
        //$('#rejectid').val(id);
        $('#leaveRejectform').attr('action', 'leaveAction/rejected_manager/'+id+'/'+lvEnd);
