          ...
          <div class="row text-center">
                ...
                ?>
                   ...
                   <div class="col-sm-12 col-md-8 col-lg-8 mb-4">
                       <h5>Design Process</h5><hr>
                       <div class="row">
                           
                           <?php $design = $this->Menu_model->get_handoverlogfordesign($cid); foreach($design as $des){?>
                           
                           <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                           <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                               
                               <b><?=$des->remark?></b><hr>
                                Task By <b><?=$des->taskby?></b><hr>
                                Task Date <b><?=$this->Menu_model->get_dformat($des->sdatet)?></b><hr>
                       ...
                       <?php $client = $this->Menu_model->get_clientbyiid($cid);?>
                       
                                <div class="row p-3 text-center">
                                  <div class="col-lg-4 col-md-3 col-sm p-3 rounded border border-info">
                                        <b>Gate Banner</b><hr>
                                        <a href="https://stemfactory.in/<?=$client[0]->backdrop?>" target="_blank">
                                            <img class="border" src="https://stemfactory.in/<?=$client[0]->backdrop?>" width="90%">
                                        </a>
                                  </div>
                                  <div class="col-lg-4 col-md-3 col-sm p-3 rounded border border-info">
                                        <b>Board Sticker</b><hr>
                                        <a href="https://stemfactory.in/<?=$client[0]->backdrop?>" target="_blank">
                                            <img class="border" src="https://stemfactory.in/<?=$client[0]->design?>" width="90%">
                                        </a>
                                  </div>
                                  <div class="col-lg-4 col-md-3 col-sm p-3 rounded border border-info">
                                        <b>Model Sticker</b><hr>
                                        <a href="https://stemfactory.in/<?=$client[0]->backdrop?>" target="_blank">
                                            <img class="border" src="https://stemfactory.in/<?=$client[0]->designed?>" width="90%">
                                        </a>
                                  </div>
                                </div>
