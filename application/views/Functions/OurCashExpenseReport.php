                ...
                <div class="card">
                  <div class="card-header bg-info text-center">
                    <h3 class="text-center">
                      <center><b>💵 Our Cash Expense Request Details</b></center>
                    </h3>
                     <small>📝 This section records all company cash expenses with dates, types, remarks, and approvals. It ensures transparency, manager verification, and smooth processing for finance and accounts team review.</small>
                  </div>
                </div>
              </div>
            </div>
              ...
              <table id="exampledata" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">🛡️ Admin Approved</th>
