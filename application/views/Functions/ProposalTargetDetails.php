<?php 
              ...
              $allpropasals             = $this->Menu_model->GetTotalPropasalByUID($slct_user_id,$start_date,$end_date);
                      ...
                      <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            ...
                            <th>Current Satus</th>
                            <th>Proposal Date</th>
                            <th>Proposal Partner</th>
                            <th>Proposal Product Types</th>
                        ...
                        <tbody>
                          <?php $i = 1; foreach($allpropasals  as $data):
                          ...
                          <tr>
                            ...
                            <td> <?php  $getpartner_name = $this->Menu_model->get_partnerbyid($data->partnerType_id)[0]->name; echo $getpartner_name;?></td>
                            ...
                            <td><?= $data->task_updateddate; ?></td>
                               */ ?>
                            <td><?= $data->current_status_name; ?></td>
                            <td><?= $data->sdatet; ?></td>
                            <td><?= $data->partner; ?></td>
                            <td><?= $data->propasal_types; ?></td>
                            
                            <td><?php 
                            $pbudgetme = $data->pbudgetme;
                            if($pbudgetme == ''){
                                $pbudgetme = 0;
                                echo $pbudgetme;
                            }else{
                            ...
                            $proattach = $data->proattach;
                                /*
                                if($proattach == 'uploads/proposal/'){
                                    echo '<span class="p-1 bg-success">No Proposal Attached</span>';
                                }else{ ?>
                                    <a href="https://stemapp.in/<?=$proattach ?>" target="_BLANK" >View</a>
                               <?php } */ ?>
                            <a href="https://stemapp.in/<?=$proattach ?>" target="_BLANK" >View</a>
