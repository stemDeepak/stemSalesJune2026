                ...
                ?>
                 <div class="card mt-2" style="background: linear-gradient(to right, #e8f5e9, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                   <div class="card-header text-center" style="background: linear-gradient(to right, #fff8e1, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                    <h3 >✏️ Minutes of Meeting (Edit MoM)</h3>
                    <small>The Edit MoM option 📝 allows team members to update or modify meeting records for accuracy and completeness 🔄. It ensures corrections, additional details, or revised decisions are properly captured ✅. By editing MoM, teams maintain transparency 🤝, keep records up to date 📑, and avoid miscommunication ⚡. This feature supports continuous improvement 🌟 and ensures that final MoM reflects the true outcomes of discussions and decisions 🚀.</small>
                  </div>    
                  <div class="card-body">
