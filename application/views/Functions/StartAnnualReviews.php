...
.create_task_bg11111{
                    ...
                    <form action="<?=base_url();?>Menu/StartAnnualReviews" method="post">
                      <div class="was-validated">
                        ...
                        <?php
                          ...
                          $cmpstatus    = $this->Menu_model->get_status();

                          // Define allowed status IDs based on type
                          $allowed_status = [];

                          if($typeid == 3){ 
                              // BD Team
                              $allowed_status = [1, 2, 8, 10, 11]; 
                          }
                          elseif(in_array($typeid, [22, 24, 13, 4])){ 
                              // RM, CM, PST, ACM
                              $allowed_status = [3, 6, 7, 12, 13, 4,5,9]; 
                          }
                          elseif($typeid == 15){ 
                              // Sales Coordinator (All)
                              $allowed_status = []; // empty = allow all
                          }
                        ...
                        ?>
                            ...
                            */ ?>
                            ...
                            <select class="form-control" id="annual_statusid" name="annual_statusid" required="">
                            <option value="0">Select Status</option>
                            <?php foreach($cmpstatus as $st){ 
                                // If not Sales Coordinator, filter
                                if(!empty($allowed_status) && !in_array($st->id, $allowed_status)){
                                    continue;
                                }
                            ?>
                                <option value="<?= $st->id ?>"><?= $st->name ?></option>
                            ...
                            <div class="col-md-4">
                              <div id="orrr">
                                ...
                                <div class="form-group">
                                  ...
                                  <div id="slctCity" class="mt-2" style="display: none;">
                                        <input type="text" class="form-control mb-2" id="citySearchInput" placeholder="Enter correct city name">
                                        <select class="form-control" id="correctCitySelect" name="company_city_right[]" required>
                                            <option value="">Start typing city name</option>
                                        </select>
                                        <small id="citySearchFeedback" class="form-text text-muted"></small>
                                    </div>

                                </div>
                                <hr>
                               <div class="form-group">
                                    <label>Is this State is Right? : <span class="clrdiff" id="cstate"></span></label>
                                    ...
                                    <div id="slctState" class="mt-2" style="display: none;">
                                        <input type="text" class="form-control mb-2" id="stateSearchInput" placeholder="Enter correct state name">
                                        <select class="form-control" id="correctStateSelect" name="company_State_right[]" required>
                                            <option value="">Start typing state name</option>
                                        </select>
                                        <small id="stateSearchFeedback" class="form-text text-muted"></small>
                                    </div>
                                </div>
                                <hr>
                          ...
                          <div>
                            ...
                            <div id="accordion">
                              ...
                              <div class="col-12 col-md-12 mb-12 card p-2">
                               ...
                               <div class="acm-bgcolor mt-1">
                                  <div class="form-group">
                                    <label> How many calls done by ACM :</label>
                                    <input type="hidden" readonly value="How many calls done by ACM ?" name="how_many_calls_done_by_acm[]"> 
                                    <textarea class="form-control" name="how_many_calls_done_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPY Calling by ACM ? :</label>
                                    <input type="hidden" readonly value="AYPY Calling by ACM ?" name="ay_py_call_by_acm[]"> 
                                    <textarea class="form-control" name="ay_py_call_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPN Calling by ACM ? :</label>
                                    <input type="hidden" readonly value="AYPN Calling by ACM ?" name="ay_pn_call_by_acm[]"> 
                                    <textarea class="form-control" name="ay_pn_call_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> ANPN Calling by ACM ? :</label>
                                    <input type="hidden" readonly value="ANPN Calling by ACM ?" name="an_pn_call_by_acm[]"> 
                                    <textarea class="form-control" name="an_pn_call_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> Is Calling Remarks Correct BY ACM (Yes/No) :</label>
                                    <input type="hidden" readonly value="Is Calling Remarks Correct BY ACM (Yes/No) ?" name="is_calling_remarks_correct_by_acm[]">
                                    <select class="form-control" name="is_calling_remarks_correct_by_acm[]" required>
                                ...
                                <div class="rm-bgcolor mt-1">
                                  <div class="form-group">
                                    <label> How many calls done by RM :</label>
                                    <input type="hidden" readonly value="How many calls done by RM ?" name="how_many_calls_done_by_rm[]"> 
                                    <textarea class="form-control" name="how_many_calls_done_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPY Calling by RM ? :</label>
                                    <input type="hidden" readonly value="AYPY Calling by RM ?" name="ay_py_call_by_rm[]"> 
                                    <textarea class="form-control" name="ay_py_call_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPN Calling by RM ? :</label>
                                    <input type="hidden" readonly value="AYPN Calling by RM ?" name="ay_pn_call_by_rm[]"> 
                                    <textarea class="form-control" name="ay_pn_call_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> ANPN Calling by RM ? :</label>
                                    <input type="hidden" readonly value="ANPN Calling by RM ?" name="an_pn_call_by_rm[]"> 
                                    <textarea class="form-control" name="an_pn_call_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> Is Calling Remarks Correct BY RM (Yes/No) :</label>
                                    <input type="hidden" readonly value="Is Calling Remarks Correct BY RM (Yes/No) ?" name="is_calling_remarks_correct_by_rm[]">
                                    <select class="form-control" name="is_calling_remarks_correct_by_rm[]" required>
                                      <option value="">Select</option>
                                      <option value="yes">Yes</option>
                                      <option value="no">No</option>
                                    </select>
                             ...
                             <div class="form-group">
                                ...
                                <div class="acm-bgcolor mt-1">
                                  <div class="form-group">
                                    <label> How many Email done by ACM :</label>
                                    <input type="hidden" readonly value="How many Email done by ACM ?" name="how_many_email_done_by_acm[]"> 
                                    <textarea class="form-control" name="how_many_email_done_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <!-- <div class="form-group">
                                    <label> AYPY Email by ACM ? :</label>
                                    <input type="hidden" readonly value="AYPY Email by ACM ?" name="ay_py_email_by_acm[]"> 
                                    <textarea class="form-control" name="ay_py_email_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPN Email by ACM ? :</label>
                                    <input type="hidden" readonly value="AYPN Email by ACM ?" name="ay_pn_email_by_acm[]"> 
                                    <textarea class="form-control" name="ay_pn_email_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> ANPN Email by ACM ? :</label>
                                    <input type="hidden" readonly value="ANPN Email by ACM ?" name="an_pn_email_by_acm[]"> 
                                    <textarea class="form-control" name="an_pn_email_by_acm[]" placeholder="Review Remark..." required></textarea>
                                  </div> -->
                                </div>


                               <div class="pst-bgcolor mt-1">
                               <div class="form-group">
                               ...
                               <div class="rm-bgcolor">
                                  <div class="form-group">
                                    <label> How many Email done by RM :</label>
                                    <input type="hidden" readonly value="How many Email done by RM ?" name="how_many_email_done_by_rm[]"> 
                                    <textarea class="form-control" name="how_many_email_done_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <!-- <div class="form-group">
                                    <label> AYPY Email by RM ? :</label>
                                    <input type="hidden" readonly value="AYPY Email by RM ?" name="ay_py_email_by_rm[]"> 
                                    <textarea class="form-control" name="ay_py_email_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> AYPN Email by RM ? :</label>
                                    <input type="hidden" readonly value="AYPN Email by RM ?" name="ay_pn_email_by_rm[]"> 
                                    <textarea class="form-control" name="ay_pn_email_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label> ANPN Email by RM ? :</label>
                                    <input type="hidden" readonly value="ANPN Email by RM ?" name="an_pn_email_by_rm[]"> 
                                    <textarea class="form-control" name="an_pn_email_by_rm[]" placeholder="Review Remark..." required></textarea>
                                  </div> -->
                                </div>
                      ...
                      */?>
                      ...
                      <div class="form-group text-center mt-3" id="reviewmainremarks">
                        ...
                        <?php 
                          ...
                          <div style="color:crimson:width:200px;">
                                <div class="form-group">
                                  <label>Do you want to plan meeting on this company ?</label>
                                  <select class="form-control" name="select_meeting_yesNoSelect" id="yesNoSelectMeetingPlan" required="">
                                    <option value="">-- Select --</option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                  </select>
                                ...
                                <div class="form-group" id="dateField" style="display:none;">
                                  <label>Select Meeting Expected Date</label>
                                  <input type="date" min="<?=date('Y-m-d');?>" class="form-control" name="meeting_date">
                                </div>
                          </div>
    ...
    $(".q1-option").change(function() {
     ...
     $('#yesNoSelectMeetingPlan').on('change', function() {
        if ($(this).val() === 'yes') {
          $('#dateField').show();
        } else {
          $('#dateField').hide();
            ...
            $("#orrr").show();
              ...
              success: function a(result){
                var jsonArray       = JSON.parse(result);
                  ...
                  var district        = jsonArray[0].district; 
                  ...
                  $("#cmpdistrict").text((district !== '')? district : 'NA');
...
$(document).ready(function() {
    ...
    // Show/hide correction div based on Yes/No selection
    $('#user_slct_city').on('change', function() {
        if ($(this).val() === 'no') {
            $('#slctCity').show();
        } else {
            $('#slctCity').hide();
            $('#citySearchInput').val('');       // clear input
            $('#correctCitySelect').html('<option value="">Start typing city name</option>');
            $('#citySearchFeedback').text('');
        }
    });

    // City search with debounce
    var searchInput = $('#citySearchInput');
    var citySelect = $('#correctCitySelect');
    var feedback = $('#citySearchFeedback');
    var debounceTimer;
    ...
    searchInput.on('keyup', function() {
        ...
        if (searchTerm.length < 2) {
            citySelect.html('<option value="">Type at least 2 characters</option>');
            feedback.text('');
            return;
        }
        ...
        debounceTimer = setTimeout(function() {
            $.ajax({
                url: '<?= base_url(); ?>Menu/getCitiesByName',
                type: 'POST',
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        citySelect.html(response.options);
                        if (response.count > 0) {
                            feedback.text(response.count + ' city(s) found').css('color', 'green');
                        } else {
                            feedback.text('No cities found').css('color', 'red');
                        }
                    } else {
                        citySelect.html('<option value="">Error loading cities</option>');
                        feedback.text('Server error').css('color', 'red');
                    }
                },
                error: function() {
                    citySelect.html('<option value="">AJAX error</option>');
                    feedback.text('Connection error').css('color', 'red');
                }
            });
        }, 300);
    });
    ...
    $('#user_slct_state').on('change', function() {
        if ($(this).val() === 'no') {
            ...
            $('#slctState').hide();
            $('#stateSearchInput').val('');
            $('#correctStateSelect').html('<option value="">Start typing state name</option>');
            $('#stateSearchFeedback').text('');
        }
    });

    var stateInput = $('#stateSearchInput');
    var stateSelect = $('#correctStateSelect');
    var stateFeedback = $('#stateSearchFeedback');
    var stateDebounce;
    ...
    stateInput.on('keyup', function() {
        ...
        if (searchTerm.length < 2) {
            stateSelect.html('<option value="">Type at least 2 characters</option>');
            stateFeedback.text('');
            return;
        }
        ...
        stateDebounce = setTimeout(function() {
            $.ajax({
                url: '<?= base_url(); ?>Menu/getStatesByName',
                type: 'POST',
                data: { search: searchTerm },
                cache: false,
                dataType: 'json',
                success: function(response) {
                    if (response.status === 'success') {
                        stateSelect.html(response.options);
                        if (response.count > 0) {
                            stateFeedback.text(response.count + ' state(s) found').css('color', 'green');
                        } else {
                            stateFeedback.text('No states found').css('color', 'red');
                        }
                    } else {
                        stateSelect.html('<option value="">Error loading states</option>');
                        stateFeedback.text('Server error').css('color', 'red');
                    }
                },
                error: function() {
                    stateSelect.html('<option value="">AJAX error</option>');
                    stateFeedback.text('Connection error').css('color', 'red');
                }
            });
        }, 300);
    });
