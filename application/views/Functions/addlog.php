  ...
  <div id="add_contact" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-form col-md-12" style="background: linear-gradient(to right, #fce4ec, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                            <div class="row no-gutters">
   ...
   <span><b>Set Contact Type?</b></span><br>
    ...
    <hr>
     <center>
        <button type="submit" class="custom-btn btn-11 mt-3" onclick="this.form.submit(); this.disabled = true;">Submit</button>
     </center>
   </form>
  </div>
  ...
  <div id="create_act" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row m-2">
                      <div class="col-12 col-md-12" style="background: linear-gradient(to right, #fcd3ff, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;" >
                        <div class="card-header gradient-text" style="background: linear-gradient(to right,rgb(211, 255, 215), #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;color: black;"><?=$compname ?> (<?=$cid?>)</div>
                        <div class="card-body">
                            Current Status : <lable><?=$current_status?></lable><br>
...
<div class="col-lg-12" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
   ...
   <input type="hidden" id="nextaction" class="form-control" name="ntnextaction"/>
...
$('#ntaction').on('change', function f() {
    ...
    var current_status_id = document.getElementById("current_status_id").value;
