...
<html lang="en">
  <head>
    ...
    <title>Closing TimeLine List Target After Quarter Review Details | STEM APP | WebAPP</title>
                  ...
                  <div class="frame-layer-2">
                    <div class="frame-layer-3" style="background: linear-gradient(to right, #ede7f6, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                     <h1 class="m-0 premium-color-1" style="color: #ff009b;">
                                    📅 Closing Timeline List Target After Quarter Review Details
                                    </h1>
                                    <br>
                                    <center>
                                    <p class="premium-color-2 text-capitalize" style="color: #ff0000; width: 60%;">
                                        🔄  <?=$cleanName = ucwords(str_replace('_____', ' → ', $timeline));?>
                                    </p>
                                    <p class="premium-color-2 text-capitalize" style="color:navy">
                                        🔄  <?=$currentQuarter;?>
                                    </p>
                                    </center>
                    </div>
                  ...
                  <table id="example10" class="table table-striped table-bordered" cellspacing="0" width="100%">
                   <thead class="thead-dark">
                      <tr>
                            ...
                            <th>🏢 Company Name</th>
                            <th>⬅️ Last Status</th>
                            <th>➡️ Current Status</th>
                            <th>👤 Main BD</th>
                            <th>📅 Marked Date</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php $ftasksc = 1; foreach($closingTimeline as $futuretask): 
                        ...
                        $backgroundColorNew = "hsl($hue, $saturation%, $lightness%)";
                         ...
                         $cleanName = ucwords(str_replace('_____', ' → ', $futuretask->timeline_name));

                        ?>
                  
                  <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                          <td><?= $ftasksc; ?></td>
                          <td class="text-capitalize"><?= $futuretask->timeline_name_by; ?></td>
                          <td class="text-capitalize"><?= $cleanName; ?></td>
                          <td class="text-capitalize"><?= $futuretask->timeline_date; ?></td>
                         ...
                         <td class="text-capitalize"><?= $futuretask->last_status; ?></td>
                         <td class="text-capitalize"><?= $futuretask->current_status; ?></td>
                         <td class="text-capitalize"><?= $futuretask->main_bd_name; ?></td>
                         <td class="text-capitalize"><?= $futuretask->marked_date; ?></td>
                        </tr>
