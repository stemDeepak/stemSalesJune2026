...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/SchoolInauguratiOnSubmit" enctype="multipart/form-data" method="post">
