...
<html lang="en">
  ...
  animation: waveBackground 60s ease infinite;
      }
      #main_timer{
          background-size: 300% 300%;
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong> <?php echo $this->session->flashdata('pending_message'); ?></strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
              </button>
            </div>
                          ...
                          <div class="form-group <?php if($revst[0]->reviewtype == 'Roaster'){ echo "mt-5"; } ?>">
                            ...
                            <div class="mt-4">
                              ...
                              <select class="form-control" id="slct_assign" name="slct_assign" required="">
                                ...
                                <?php } else if($typeid == 13 || $typeid == 24){ ?>
                              ...
                              <select class="form-control" id="statusid" name="statusid" required="">
                                ...
                                <?php 
                                  ...
                                  if($slctreviewtype == 'Half Yearly' || $slctreviewtype == 'Self Half Yearly'){
                                    ...
                                    if(in_array($tcu_type_id, [2,4,19,20,21,22,23])){
                                    ...
                                    if(in_array($tcu_type_id, [2,4,19,20,21,22,23])){
                                     ...
                                     if($slctreviewtype == 'Querterly' || $slctreviewtype == 'Self Quarterly' || $slctreviewtype == 'Quarterly'){
                          ...
                          <div class="was-validated">
                            <form action="<?=base_url();?>Menu/closereview" method="post">
                              ...
                              <div class="form-group">
                                ...
                                <input type="datetime-local" readonly name="closetdate" value="<?=date('Y-m-d H:i:s');?>" class="form-control mt-3" required="">
                          ...
                          <div class="row">
                                ...
                                <div class="form-group">
                                  ...
                                  <div id="slctState" class="mt-2">
                                    <select class="form-control" name="company_State_right[]" required="">
                                      <?php 
                                      // $state = $this->Menu_model->GetState();
                                      $state  = [];
                                      ?>
                                      <option value="" selected disabled >Select</option>
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                ...
                                <?php 
                                // $clusters = $this->Menu_model->getAllActiveTravelClusterByUserId($uid);
                                $clusters = [];
                                ?>
                                  ...
                                  <select class="form-control" name="travel_cluster[]" required="">
                                    <option value="" selected disabled >Select Travel Cluster </option>
                                      <?php foreach($clusters as $cluster){
                                          $state_title       = $cluster->state_title;
                                          $district_titles   = $cluster->district_titles;
                                          $city_titles       = $cluster->city_titles;
                                          $travelClusterHover = "State : ".$state_title.' | District :'.$district_titles .' | City'.$city_titles;
                                        ?>
                                        <option title = "<?=$travelClusterHover?>" value="<?=$cluster->id?>"><?=$cluster->clustername?> (<?=$cluster->username?>)</option>
                                      <?php } ?>
                                  </select>
                                </div>
                              </div>
                                      ...
                                      <?php /*
                                        <hr>
                                          <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="travel_cluster" value="Travel Cluster is Right or not ?">
                                            <select class="form-control" id="Checktravelcluster" name="Checktravelcluster" required="">
                                              <option value="" selected disabled >Select</option>
                                              <option value="yes">Yes</option>
                                              <option value="no">No</option>
                                            </select>
                                          ...
                                          <?php $clusters = $this->Menu_model->getAllActiveTravelClusterByUserId($uid);?>
                                          <div class="form-group mt-2" id="add_slct_cluster_card">
                                            <select class="form-control" name="new_travel_cluster" required="">
                                              <option value="" selected disabled >Select Travel Cluster </option>
                                              <?php foreach($clusters as $cluster){
                                                 $state_title       = $cluster->state_title;
                                                 $district_titles   = $cluster->district_titles;
                                                 ...
                                                 $travelClusterHover = "State : ".$state_title.' | District :'.$district_titles .' | City'.$city_titles;
                                                ?>
                                              <option title = "<?=$travelClusterHover?>" value="<?=$cluster->id?>"><?=$cluster->clustername?> - <?=$cluster->travel_type?> - (<?=$cluster->username?>)</option>
                                              <?php } ?>
                                            </select>
                                          </div>
                                          <hr>
                                        ...
                                        */  ?>
                                          ...
                                          <lable>The Company is Business Protentional:
                                            <select class="form-control" name="business_protentional" required="">
                                              <option value="" selected disabled >Select</option>
                                              <option value="yes">Yes</option>
                                              <option value="no">No</option>
                                            </select>
                                          ...
                                          <hr>
                                          <div class="form-group mt-2">
                                          <!-- <lable>This company is one of our anchor clients : -->
                                          <lable>This <span id="company_anchor" style="color: navy;"></span> one of our anchor clients :
                                            <select class="form-control" name="anchor_clients" required="">
                                              <option value="" selected disabled >Select</option>
                                              <option value="yes">Yes</option>
                                              <option value="no">No</option>
                                            </select>
                                          ...
                                          ?>
                                          <div class="form-group mt-2">
                                            <lable>Add in New Category :
                                            <input type="hidden" name="Q_new_category" value="<?=$currentQuarter;?>">
                                            <select class="form-control" name="new_category" required="">
                                              <option value="" selected disabled >Select</option>
                                              <option value="20 Closure Funnel in <?=$currentQuarter;?>"><lable>20 Closure Funnel	in <?=$currentQuarter;?></option>
                                          ...
                                          <hr>
                                            <div class="form-group">
                                              <lable>Need to Change Partner Type? : 
                                                <span class="clrdiff" id="slct_curremt_partner_type"></span>
                                              </lable>
                                              <select class="form-control" name="slct_change_partner_type_q" required="" id="slct_change_partner_type_q">
                                                <option value="" selected disabled >Select </option>
                                                <option value="yes">Yes</option>
                                                <option value="no">No</option>
                                              </select>
                                              <div class="form-group mt-2" id="slct_change_partner_type_card">
                                                <select class="form-control" name="slct_change_partner_type" required="">
                                                  <option value="" selected disabled >Select Partner Type</option>
                                                  <?php $partners = $this->Menu_model->get_partner();
                                                    foreach($partners as $part){?>
                                                  <option value="<?=$part->id?>"><?=$part->name?></option>
                                            ...
                                            <hr>
                                               ...
                                               <hr>
                                            <div class="form-group">
                                              <lable>Select Current <?=$currentQuarter;?> Target Status: </lable>
                                              <hr>
                                              <select class="form-select" id="generatetimelineStatus" onchange="generateTable()" style="opacity: 0;">
                                              </select>
        ...
        <script type='text/javascript'>
          $( document ).ready(function() {
              ...
              $("#add_slct_cluster_card").hide();
              $("#mainlogtable").hide();
              $("#slct_change_partner_type_card").hide();
            ...
            if(load_rtype !== 'Roaster'){
              $.ajax({
                      ...
                      if(result == 0){
                        ...
                        // if(bdid == pstid){
                            $.ajax({
                              url:'<?=base_url();?>Menu/CheckTargetSettingDoneOrNot',
                              type: "POST",
                              data: {
                              review_id: review_id
                              },
                              cache: false,
                              success: function a(result){
                              var intTargetResult = Number(result);
                                if(intTargetResult == 0){
                                  var current_slsct_review_id = $("#slsct_review_id").val();
                                alert("* Good job! You have successfully completed the review. Now you can set the target. Once the target is set, you can close the current review.");
                                  window.location.href = "https://stemapp.in/Menu/AddTarget/"+current_slsct_review_id;
                                }
                              }
                          });
                        // }
                        ...
                        var presentuserrolesID = <?=$user['type_id'];?>;
                        if(presentuserrolesID != 1 || presentuserrolesID != 2 || presentuserrolesID != 6 || presentuserrolesID != 15 || presentuserrolesID != 19 || presentuserrolesID != 20 || presentuserrolesID != 21 || presentuserrolesID != 22 || presentuserrolesID != 23){
          ...
          $('#slct_partner_type').on('change', function() {
           ...
           $('#slct_change_partner_type_q').on('change', function() {
            var val = this.value;
            if (val == 'yes') {
              $("#slct_change_partner_type_card").show();
              $("#slct_change_partner_type_card select").attr('required', true);
            } else {
               $("#slct_change_partner_type_card").hide();
               $("#slct_change_partner_type_card select").removeAttr('required');
            }
          });
          ...
          $('#Checktravelcluster').on('change', function() {
            var val = this.value;
            if (val == 'no') {
                $("#add_slct_cluster_card").show();
                $("#add_slct_cluster_card select").attr('required', true);
            } else {
                $("#add_slct_cluster_card select").removeAttr('required');
                $("#add_slct_cluster_card").hide();
            }
          });
          ...
          var selectedTargetStatusValue = $(this).val();
          var selectedTargetStatusText = $(this).find('option:selected').text();
          // Clear existing options and add new ones
          $("#generatetimelineStatus").html(''); // optional: clear previous options

          $("#generatetimelineStatus").append(
              $('<option>', {
                    value: selectedTargetStatusValue,
                    text: selectedTargetStatusText,
                    selected: true
                })
            );

            var get_slctreviewtype1 = '<?=$slctreviewtype?>';

  // Only add inputs if review type matches
  if(
    get_slctreviewtype1 === 'Querterly' || 
    get_slctreviewtype1 === 'Quarterly' ||
    get_slctreviewtype1 === 'Self Quarterly'
  ){
generateTable();
  }
          ...
          success: function a(result){
              ...
              success: function a(result){
                  ...
                  $("#company_anchor").text((companyName !== '')? companyName : 'NA');
              ...
              success: function a(result){
                  ...
                  // var cluster_id      = jsonArray[0].cluster_id; 
                      ...
                      success: function a(result){
                          ...
                          $("#slct_curremt_partner_type").html("<b> : "+result+"<b>");
                      }
                      });
              }
              });
          ...
          cache: false,
          success: function a(cmpdata){
            var cmpjsonData = JSON.parse(cmpdata);

            var apstValue = cmpjsonData[0].apst
            var clmValue = cmpjsonData[0].clm_id;
            var init_id = cmpjsonData[0].id;
            var cluster_id = cmpjsonData[0].cluster_id;

            var ccompany_master = cmpjsonData[0].compname;
            $("#company_anchor").text((ccompany_master !== '')? ccompany_master : 'NA');

            if (cluster_id != 'Select Cluster' && cluster_id != '') {

                $.ajax({
                  url: '<?= base_url(); ?>Menu/getExistCompanyCluster',
                  type: "POST",
                  data: {
                      cluster_id: cluster_id,
                      ccompany_master: ccompany_master
                  },
                  cache: false,
                  dataType: "json", // Important if the server returns JSON
                  success: function (cluster_response) {
                      if (cluster_response.length > 0) {
                          var state_title       = cluster_response[0].state_title;
                          var district_titles   = cluster_response[0].district_titles;
                          var city_titles       = cluster_response[0].city_titles;
                          var travelId          = cluster_response[0].travelId;
                          var travelType        = cluster_response[0].travelType;
                          var cluster_create_by = cluster_response[0].username;
                          var clustername       = cluster_response[0].clustername;
                           $("#htmlClusterDiv").html("");
                          var htmlCluster = `
                                      <div style="
                                          ...
                                          color: #2c3e50;
                                      ">
                                          <h3 class="p-2" style="margin-top: 0; color: #2980b9;">Cluster Information</h3>
                                          <h4 class="p-2" style="margin-top: 0; color:rgb(245, 22, 130);">${ccompany_master}</h4>
                                          <p><strong>Cluster Name:</strong> <span style="color:#8e44ad;">${clustername}</span></p>
                                          <p><strong>Created By:</strong> <span style="color:#16a085;">${cluster_create_by}</span></p>
                                          <p><strong>State:</strong> <span style="color:#e67e22;">${state_title}</span></p>
                                          <p><strong>District(s):</strong> <span style="color:#d35400;">${district_titles}</span></p>
                                          <p><strong>City/Cities:</strong> <span style="color:#c0392b;">${city_titles}</span></p>
                                          <p><strong>Travel Type:</strong> <span style="color:#2980b9;">${travelType}</span></p>
                                      </div>
                                  `;

                              $("#htmlClusterDiv").html(htmlCluster);
                      }
                  }
              });
                 ...
                 $("#htmlClusterDiv").html("");
                        var htmlCluster = `
                                      <div style="
                                          ...
                                          color: #2c3e50;
                                      ">
                                          <h3 class="p-2" style="margin-top: 0; color:rgb(248, 22, 116);">${ccompany_master}</h3>
                                          <h4 class="p-2" style="margin-top: 0; color: #2980b9;">No Cluster Found i !</h4>
                                      </div>
                                  `;
                          $("#htmlClusterDiv").html(htmlCluster);
              }
  ...
  const selected = document.getElementById("generatetimelineStatus").value;
  ...
  var get_slctreviewtype = '<?=$slctreviewtype?>';

  // Only add inputs if review type matches
  const allowTimelineInputs = (
    get_slctreviewtype === 'Querterly' ||
    get_slctreviewtype === 'Quarterly' ||
    get_slctreviewtype === 'Self Quarterly'
  );
  ...
  for (let i = 0; i < list.length - 1; i++) {
    ...
    let inputFields = `<td class="text-muted">Timeline not required</td>`;
    if (allowTimelineInputs) {
      inputFields = `
        <td>
          <input type="hidden" class="form-control" name='timeline_date[]' value="${inputName}">
          <input type="date" class="form-control" name='timeline_date[]' id="stat_${i}" required>
        </td>
      `;
    }
  ...
  // Date chaining logic (only apply if inputs exist)
  if (allowTimelineInputs) {
    for (let i = 0; i < list.length - 2; i++) {
      ...
      if (currentInput && nextInput) {
        currentInput.addEventListener("change", function () {
          ...
          nextInput.setAttribute("max", maxStr);
        });
      }
    }
  }
