        ...
        <section class="content">
          <div class="container-fluid">
            ...
            if($cluster_id == 0){
                ...
                $clusterData         = $this->Menu_model->getClusterByUserclId($cluster_id);
                if(sizeof($clusterData) > 0){
                    $cluster_in_state    = $clusterData[0]->in_state;
                    $cluster_in_district = $clusterData[0]->in_district;
                    $cluster_in_city     = $clusterData[0]->in_city;
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <div class="text-center ">
                      <h3>Update Client Details (CID - <?=$cmpid_id?>)</h3>
                    </div>
                  </div>
                  <!-- /.card-header -->
                                ...
                                <div class="col-12 col-md-12 mb-12">
                                    ...
                                    <select id="cluster" class="form-control" name="cluster" required>
                                       ...
                                       <?php foreach($clusterData as $cdata):
                                        ...
                                        ?>
                                       <option <?= $selected; ?> value="<?=$cdata->id?>"><?=$cdata->clustername ?> (<?=$cdata->travel_type ?>) - <?=$cdata->username ?></option>
                                       <?php endforeach; ?>
                                  </select>
                          ...
                          <div class="was-validated">
                            ...
                            <div class="form-row">
                              ...
                              <div class="col-12 col-md-12 mb-12">
                                  ...
                                  <input type="text" value="<?= $bmdata[0]->linked_in ?>" name="linked_in" class="form-control" id="linked_in" placeholder="Add Linked In Profile" value="" required=""  >
                                  <div class="invalid-feedback">Please provide a Linked In Profile.</div>
                                  <div class="valid-feedback">Looks good!</div>
                              </div>
                              <div class="col-12 col-md-12 mb-12">
                                <label for="validationSample02">Email ID</label>
                                <input type="email" class="form-control" id="emailid" placeholder="Enter Email Id" value="<?=$bmdata[0]->emailid?>" name="emailid"  required="">
                            ...
                            <div class="form-row">
                              <div class="col-12 col-md-12 mb-12">
                                ...
                                <?php 
                                if($bmdata[0]->phoneno == ''){ $phonepattern ='pattern="[0-9]{10}"';}else{$phonepattern = '';}
                                 ?>
                                <input type="text" minlength="10" maxlength="10" <?=$phonepattern?> class="form-control" id="phoneno"  value="<?= $bmdata[0]->phoneno ?>" name="phoneno" placeholder="Enter 10-digit Mobile Number" required="">
                ...
                var contactGroup = `
                    <div class="contact-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-6">
                                  <label for="new_linked_in">Linked In Profile</label>
                                  <input type="text" name="new_linked_in[]" class="form-control"  placeholder="Add Linked In Profile"  required >
                                  <div class="invalid-feedback">Please provide a Linked In Profile.</div>
                                  <div class="valid-feedback">Looks good!</div>
                              </div>
