...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              ...
              <hr>
                <div class="container">
                  <?php $tasktypeLists = $this->Menu_model->GetTaskTypeListOnOperationsTeam(); ?>

                  <div class="row">
                      <div class="col-md-6">
                          <label>PAYMENT TERMS By Task Type</label>
                          <select class="form-control select2" id="paytermby_tasktype">
                              <option value="">Select Task Type</option>
                              <?php foreach($tasktypeLists as $tasktypeList): ?>
                                  <option value="<?= $tasktypeList->tasktype; ?>">
                  ...
                  <!-- Dynamic Rows -->
                  <div id="payment_terms_container"></div>
              </div>
              <hr>
...
$(document).ready(function(){
    ...
    $('#addRow').click(function(){
        ...
        let taskType = $('#paytermby_tasktype').val();

        if(taskType == ''){
            alert('Please select Task Type first');
            return;
        }
        ...
        <div class="row mb-2" id="row_${rowCount}">
            ...
            <div class="col-md-5">
                <input type="text" name="tasktype[]" class="form-control" value="${taskType}" readonly>
            </div>

            <div class="col-md-5">
                <input type="number" name="percentage[]" class="form-control" placeholder="Enter % (e.g. 20)">
            </div>

            <div class="col-md-2">
                <button type="button" class="btn btn-danger removeRow" data-id="${rowCount}">
                    X
                </button>
            </div>
        ...
        $('#payment_terms_container').append(html);
    });
