...
tbody tr td:nth-child(2) {
    ...
    color: black;
                  ...
                  <div class="card-header text-center" style="background: linear-gradient(to right, #fff8e1, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
                    <h3 >📑 Minutes of Meeting (Approved MoM Data)</h3>
                    <small>The Approved MoM Data 📊 provides a detailed record of discussions, decisions, and agreed actions during the meeting ✅. It ensures transparency, accountability, and proper follow-up on tasks 🗂️. With clear documentation, team members stay aligned, avoiding miscommunication 🤝. This record also acts as a reliable reference 📌 for future planning, progress tracking, and performance evaluation to drive efficiency 🚀.</small>
                  </div>
                             ...
                             <div class="table-responsive text-nowrap" style="overflow-x: auto;">
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                    <?php 
                                      $i=1;
                                      $momdata = $this->Management_model->GetApprovedSubmitBDMoMData($suid,$tardate);
                                    ...
                                    <a target="_BLANK" href="<?=base_url()?>Menu/CompanyDetails/<?=$cid?>">
                                      ...
                                      <td> 
                                        ...
                                        <a class="btn btn-primary" target="_blank" href="<?=base_url().'Management/MomDataDisplay/'.$dt->user_id.'/'.$tardate.'/'.$dt->id;?>"> View Mom Details
                                    </a>
                                </td>
                                 <td> 
                                      ...
                                      <?php if($dt->approved_status == 'Reject' && ($dt->edit_cnt == '' || $dt->edit_cnt == 0)){ ?>
                                        <div>
                                          <p><?php echo "<span class='bg-danger p-2'>Rejected</span>"; ?></p>
                                            <p><a href="<?=base_url();?>Management/MomEditByUser/<?= $dt->id?>/edit/<?=$suid?>/<?=$tardate?>" class="btn btn-primary mr-2" >Edit</a></p>
                                        </div>
                                        <?php }?>
