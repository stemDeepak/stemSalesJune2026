                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                         <td><?=$i?></td>
                                         <td><button style="background: none;color: inherit;border: none;padding: 0;font: inherit;cursor: pointer;outline: inherit;" id="DeleteC<?=$i?>" value="<?=$cid?>">Edit</button></td>
                                         <td><?=$badname?></td>
                                         <td><?=$pstname?></td>
                                         <td><?=$cd[0]->id?></td>
                                         <td><a href="../CompanyDetails/<?=$cid?>"><?=$cd[0]->compname?></a></td>
                                         <td><?=$init[0]->noofschools?></td>
                                         <td><?=$init[0]->fbudget?></td>
                                         <td><?=$logs?></td>
                                         <td><?=$cd[0]->state?></td>
                                         <td><?=$cd[0]->city?></td>
                                         <td><?=$cd[0]->draft?></td>
