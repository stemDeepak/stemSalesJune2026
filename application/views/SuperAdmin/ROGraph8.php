    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>My Region School Avg Utilisation</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $status = $this->Menu_model->get_mravguti($uid);
      foreach ($status as $st) {
        $statusName = "My School Avg Utilisation (" . $st->mavguti . ")";
        echo "data.addRow(['$statusName', $st->mavguti, '', '$uid']);";
        $statusName = "Others School Avg Utilisation (" . $st->oavguti . ")";
        echo "data.addRow(['$statusName', $st->oavguti, '', '$uid']);";
      }
      ?>
