...
<head>
  ...
  <title>Get All Replaned Log Planned By Users | STEM APP | WebAPP</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-primary" style="align-items: center; justify-content: center; display: flex ;">
                <h3 class="card-title">All Replaned Log Planned By Users</h3>
              </div>
              <div class="card-body">
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" wi$dth="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data->re_created_at; ?></td>
                                            <td><?= $data->name; ?></td>
                                            <td><?= $data->duplicate_count; ?></td>
