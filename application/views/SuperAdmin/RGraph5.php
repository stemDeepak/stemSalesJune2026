    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>BD Request Client Type Wise</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $status = $this->Menu_model->get_bdrponnew($uid);
      foreach ($status as $st) {
        $statusName = "onborded (" . $st->onborded . ")";
        echo "data.addRow(['$statusName', $st->onborded, '', '$uid']);";
        
        $statusName = "newclient (" . $st->newclient . ")";
        echo "data.addRow(['$statusName', $st->newclient, '', '$uid']);";
