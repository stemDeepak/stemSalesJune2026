  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="text-center m-3">BD Funnel Detail Acording to Categories</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            <div class="table-responsive text-nowrap">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      ...
                                      foreach($mdata as $dt){
                                            $bdid = $dt->user_id;
                                            $mbd=$this->Menu_model->get_mbdc($bdid);
                                    ...
                                    <tr>
                                        <td><?=$i?></td>
                                        <td><?=$dt->name?></td>
                                        <td><a href="<?=base_url();?>Menu/bdcompanies/0/<?=$bdid?>"><?=$mbd[0]->a?></a></td>
