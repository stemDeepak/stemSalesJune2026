...
<html lang="en">
  <head>
    ...
    <title>Update Company - Annual Company Report | STEM APP| WebAPP</title>
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                        ...
                        <div class="bg-warning colapsboxsha text-center mt-2 mb-2">
                          <h3><i>Update Company </i></h3>
                        </div>

                            
                        
                        <div class="card p-3 d-flex">
                             <form action="<?php echo site_url('Menu/UploadCompanyCSV'); ?>" method="post" enctype="multipart/form-data">
