  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="card">
                    <?php $users = $this->Menu_model->get_allactiveuserbyaid($uid);$tdate=date('Y-m-d', strtotime('+1 day'));?>
                    <div class="card-header"><center><h5><b>Next Day Plan Task (<?=$tdate?>)</b></h5></center></div>
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                <th>Name</th>
          ...
          <div class="col-12">
              <?php $time1 = array('09:00:00', '11:00:00', '13:00:00','15:00:00','17:00:00','19:00:00');
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      <?php foreach($users as $user){
                          ...
                          $ted = $this->Menu_model->get_alluserttbytimed($uid,$tdate,$t1,$t2);?>
                      <div class="row">
