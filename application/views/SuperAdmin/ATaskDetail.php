            ...
            <fieldset>
					    ...
					    <th>CIN</th>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($nextCFID !=0){ ?>
                                          <?=date('d-m-Y h:i A', strtotime($intime = $md->initiateddt));?>
                                          <?php }else{
                                            echo 'No Initiated';
                                          } ?>
                                        ...
                                        <td>
                                          <?php if($nextCFID !=0){ ?>
                                            <?=$this->Menu_model->timediff($pltime,$intime)?>
                                          <?php }else{
                                            echo 'Not Complete';
                                          } ?>
                                        ...
                                        <td>
                                          <?php if($nextCFID != 0){ ?>
                                            <?=date('d-m-Y h:i A', strtotime($uptime = $md->updateddate));?>
                                          <?php }else{
                                            echo 'Not Complete';
                                          } ?>
                                        ...
                                        <td>
                                          ...
                                          <?php if($nextCFID !=0){ ?>
                                            <?=$this->Menu_model->timediff($pltime,$uptime)?>
                                          <?php }else{
                                            echo '';
                                          } ?>
                                        </td>
                                        <td>
                                          ...
                                          <?php if($nextCFID !=0){ ?>
                                            <?=$this->Menu_model->timediff($intime,$uptime)?>
                                          <?php }else{
                                            echo '';
                                          } ?>
