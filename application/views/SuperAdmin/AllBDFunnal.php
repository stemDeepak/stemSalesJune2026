              ...
              <div class="col-12">
                <div class="card content-card mt-2">
                  ...
                  <div class="form-container">
                    ...
                    <form class="form-inline mt-2" action="<?=base_url().'Menu/AllBDFunnal/'.$uid;?>" method="POST">
                    ...
                    <form class="form-inline mt-2" action="<?=base_url().'Menu/AllBDFunnal/'.$uid;?>" method="POST">
                      <div class="form-group mx-sm-3 mb-2">
                        ...
                        <select class="form-control" name="category">
                          <option value="">Select</option>
                          <option value="Q1 20 Closure Funnel" <?php echo ($thisyear == 'Q1 20 Closure Funnel') ? 'selected' : ''; ?>>Q1 20 Closure Funnel</option>
                          <option value="Potential Funnel For FY" <?php echo ($thisyear == 'Potential Funnel For FY') ? 'selected' : ''; ?>>Potential Funnel For FY</option>
                          <option value="To be Nurtured for FY" <?php echo ($thisyear == 'To be Nurtured for FY') ? 'selected' : ''; ?>>To be Nurtured for FY</option>
                          <option value="50 New Lead Funnel" <?php echo ($thisyear == '50 New Lead Funnel') ? 'selected' : ''; ?>>50 New Lead Funnel</option>
                        </select>
                      </div>
                      <button type="submit" class="btn btn-primary mb-2">Filter</button>
                    </form>
