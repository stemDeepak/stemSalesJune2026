  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Expected PST School</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                            ...
                            <div class="pdf-viwer">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        $i=1;
                                        $mdata=$this->Menu_model->get_pstexschool($pstid);
                                        foreach($mdata as $dt){
                                            $cid = $dt->cmpid_id;
                                    ...
                                    <tr>
                                         ...
                                         <td><?=$pstname?></td>
                                         <td><?=$cd[0]->id?></td>
                                         <td><a target="_blank" href="<?=base_url();?>Menu/CompanyDetails/<?=$cid?>"><?=$cd[0]->compname?></a></td>
                                         <td><?=$sid?></td>
                                         <td><?=$dt->exschool?></td>
                                         <td><?=$dt->exrevenue?></td>
                                         <td><?=$logs?></td>
                                         <td>
                                             <?php 
                                                $olddate='';$olds='';foreach($tblc as $cd){
