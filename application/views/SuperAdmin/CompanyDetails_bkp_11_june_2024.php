...
<html lang="en">
  <head>
    ...
    <title>Company Details - STEM APP | WebAPP</title>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <div class="row">
                  ...
                  <div class="col-sm col-lg-8"><?=sizeof($tblc_new)?></div>
        ...
        <br/>
        <div class="btn btn-danger colapsboxsha col-md-12 col-lg-12 mt-2 d-flex justify-content-between align-items-center" data-toggle="collapse" href="#collapseExample<?=$k?>" role="button" aria-expanded="false" aria-controls="collapseExample<?=$k?>">
          Pending Task Logs - :  
        </div>
        <div class="collapse show mt-3" id="collapseExample<?=$k?>">
          <div class="card card-body" style="background: azure;"  >
            <div class="ApprovedStatus">
              <div class="table-responsive">
                <table id="example3" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php $i=1; foreach($tblc_new as $tb){
                      $tid = $tb->id;
                      $uid = $tb->user_id;
                      $aid = $tb->actiontype_id;
                      $ui=$this->Menu_model->get_userbyid($uid);
