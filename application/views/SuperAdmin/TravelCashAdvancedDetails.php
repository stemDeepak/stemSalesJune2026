      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="container-fluid">
            ...
            <div class="container card p-2" style="background: linear-gradient(to right, #e8f5e9, #ffffff); border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 20px;">
               <div class="row">
        ...
        if($account_by != 0){
          $accountPersonDatas = $this->Menu_model->GetFactoryUserDetails($account_by); 
          $account_by_name = $accountPersonDatas[0]->fullname;
        }else{
          $account_by_name = "<span class='bg-warning p-1'>Pending</span>";
        }
        ...
        echo '
          <div class="step">
            ...
            <div class="collapse collapse-content text-center" id="accountDetails">
              <p><strong> By:</strong> ' . $account_by_name . '</p>
