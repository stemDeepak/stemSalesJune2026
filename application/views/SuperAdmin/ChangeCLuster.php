  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="text-center m-3 text-secondary">Funnel Transfer Cluster to Cluster</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        <div class="page-header">
            <div class="form-group">
                <form action="" method="POST">
                    <lable>Cluster From</lable>
                    <Select name="fCluster">
                        <option>From Cluster</option>
                        <?php foreach($mdata as $md){?>
                        <option value="<?=$md->user_id?>"><?=$md->name?></option>
                        <?php }?>
                    </Select>
                    <lable>Cluster To</lable>
                    <Select name="tCluster">
                        <option>To Cluster</option>
                        <?php foreach($mdata as $md){?>
                        <option value="<?=$md->user_id?>"><?=$md->name?></option>
                        <?php }?>
                    </Select>
                ...
                <fieldset>
                        <div class="table-responsive">
                            <div class="table-responsive"> 
                            <form action="<?=base_url();?>/Menu/CMFunnelTransfer" method="POST">
                                <?php if(isset($_POST['tCluster'])){
                                  $tpst = $_POST['tCluster'];?>
                                <input type="hidden" name="toCluster" value="<?=$tpst?>">
                                <?php } 
                                
                                if(isset($_POST['fCluster'])){
                                  $fpst = $_POST['fCluster'];
                                      $cdata=$this->Menu_model->get_cdbycluster($fpst);?>
                                      
                                      <input type="hidden" name="foCluster" value="<?=$fpst?>">
