                            ...
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" wi$dth="100%">
                                  ...
                                  <tr>
                                        ...
                                        <td><?=(isset($md->initiateddt) && $md->initiateddt != NULL) ? date('d-m-Y h:i A', strtotime($intime = $md->initiateddt)) : '--';?></td>
                                        <td><?=(isset($md->initiateddt) ) ? $this->Menu_model->timediff($pltime,$intime) : '--'?></td>
                                        <td><?=date('d-m-Y h:i A', strtotime($uptime = $md->updateddate));?></td>
                                        <td><?=$this->Menu_model->timediff($pltime,$uptime)?></td>
                                        <td><?= (isset($md->initiateddt) ) ?  $this->Menu_model->timediff($intime,$uptime) : '--'?></td>
                                        <td><?=$nltime?></td>
                                        <td><?=$nctime?></td>
