...
$pst = $this->Menu_model->get_pstbyaid($uid);
...
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/TeamDailyReport/<?=$tdate?>">
    <input type="date" name="sdate" class="mr-2">
    <select name="bdid">
            ...
            <div class="">
                <div class="">
                        ...
                        <tbody>
                            ...
                            $startTimeStamp = strtotime($tdate);
                            $endTimeStamp = strtotime($tdate);
