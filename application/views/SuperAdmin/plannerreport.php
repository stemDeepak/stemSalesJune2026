  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Planner Report Status Wise</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/plannerreport">
                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                        <?php 
                                        $i=1;
                                        $mtdata = $this->Menu_model->get_plannersreport($bdid,$sdate,$edate,$stid);
