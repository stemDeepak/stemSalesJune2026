                                  ...
                                  <div class="col-12 col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-12 mb-3">
                                            ...
                                            <div id="sra_of_company" class="card mt-2 mb-2">
                                               <h4 class="text-center p-2">Work Order</h4> <hr>
                                                <label>No of School</label>
                                                <input type="number" class="form-control" name="no_of_school" id="no_of_school_on_closure">
                                                <label>Revenue</label>
                                                <input type="number" class="form-control" name="revenue" id="revenue_on_closure">
                                                <label>Attachment</label>
                                                <input type="file" class="form-control" name="filname" id="attach_on_closure">
                                            </div>
                                        </div>
           ...
           if(len > 0){
            ...
            // var cpurpose = response[0].cpurpose;
             ...
             if(action_id == 1){
              ...
              $('#ystatus').change(function() {
                  var selectedValue_ystatus = $(this).val();
                  if(selectedValue_ystatus == 7){
                    $("#sra_of_company").show();
                  }else{
                    $("#sra_of_company").hide();
                  }
             ...
             $('#add_note').modal('hide');
             alert("* Please Add Primary Contact First");
             $('#add_note').modal('hide');
           }
         }
       });
