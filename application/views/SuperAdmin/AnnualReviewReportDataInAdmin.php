...
?>
                                    ...
                                    <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                          <thead>
                                                <tr>
                                                      ...
                                                      <th>Cluster Manager Approve Pending</th>
                                                      <th>Cluster Manager Reject</th>
                                                      <th>PST Approve</th>
                                                      <th>PST Approve Pending</th>
                                                      <th>PST Reject</th>
            ...
            <?php $j=1;
                ...
                ?>
                    ...
                    <td><?=abs($udata['reviewDone'][$t->user_id] - $udata['cluster_approve'][$t->user_id])?></td>
                    <td><?=$udata['cluster_reject'][$t->user_id]?></td>
                    <td><?=$udata['pst_approve'][$t->user_id]?></td>
                    <td><?=abs($udata['reviewDone'][$t->user_id] -$udata['pst_approve'][$t->user_id])?></td>
        ...
        <!-- Modal -->
                ...
                <?php $k=1;
                    ...
                    ?>
                        ...
                        <td><a href="<?=base_url();?>Menu/newFinancialYearData/<?=$t->user_id?>/focusPositiveKeyClient"><?=$udata['focusPositiveKeyClient'][$t->user_id]?></a></td>
            ...
            <!-- Modal -->
                         ...
                         <a href="<?=base_url();?>Menu/getUpdatedReviewDetailsByUser">
                   <button class="btn btn-primary colapsboxsha col-md-12 col-lg-12 mt-2 d-flex justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#collapseExample911" aria-expanded="false" aria-controls="collapseExample">
                    After Funnel Update Summary Of Financial year 2024-25
                  </button>
