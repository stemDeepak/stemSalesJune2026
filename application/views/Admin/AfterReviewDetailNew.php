          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-12 card bg-primary text-center p-2">
                <h1 class="m-0">After Review Current Scenario</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
				  ...
				  <td><?=$md->cid;?></td>
                                  ...
                                  <td>
                                    <?php $olddate='';$olds=''; foreach($cdata as $cd){
                                      ...
                                      ?>
                                    <b><?=$cd->aname?></b> Updated by <b><?=$cd->umane?></b> on <?=$cd->updateddate?> <b><?=$timed?></b> <?=$olds?> to <?=$cd->sname?> <br><b>Remark:</b> <?php if($cd->remarks==''){echo 'this task is not performed';} else{echo $cd->remarks;}?>
                                    <b><?php if($cd->autotask == 1){echo 'and this task is Auto Task';}else{echo '';} ?></b>
