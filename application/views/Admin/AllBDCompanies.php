          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-12">
                <div class="card">
                <?php
                $userd = $this->Menu_model->get_userbyid($bdid);
                $username = $userd[0]->name;
                ?>
                  <div class="card-header text-center">
                    <h3 class="text-center m-3" style="color: #f7008d !important;">BD FUNNEL DETAILS</h3>
                    <span class="text-success"><strong><?=$username;?></strong></span><br>
                                    ...
                                    <tbody>
                                      <?php 
                                        ...
                                        foreach($mdata as $dt){
                                            ...
                                            $cluster_id = $init[0]->cluster_id;
                                            
                                            if (!empty($cluster_id) && $cluster_id !== 'Select Cluster' && $cluster_id !== '' && $cluster_id !== 0 && !is_null($cluster_id)) {
                                              $meet_clusternameData = $this->Menu_model->getClusterByidwithName($cluster_id);
                                              
                                              $cluster_added_name  = $meet_clusternameData[0]->cluster_added_name;
                                          ...
                                          $cityData = rtrim($cityData, " | ");
                                               ...
                                               $base_title_message = '<span class="bg-color-regular">Cluster Create By : '.$cluster_added_name.' <hr> Cluster Name : '.$clustername_name.' <hr> State : '.$inState.' <hr> District : '.$distData.' <hr> City : '.$cityData.'</span>';
                           
                                           }else{
                                               $base_title_message = '<span class="bg-color-regular">No Cluster Found </span>';
                                           }
          ...
          <div class="modal-body">
            <div class="card card-form col-md-12">
              ...
              <div class="col-lg-12 card-body">
                ...
                <textarea rows="10" name="dremark" class="form-control" required></textarea>
                <hr>
