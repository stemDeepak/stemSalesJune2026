                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <input type="hidden" name="user_id" value="<?=$user['user_id']?>">
                            <center> <h3><?php if($type == 'quarter1'){
                                echo "Focus For Quarter 1";
                            }else if($type == 'quarter2'){echo "Focus For Quarter 2";
                            }else if($type == 'quarter3'){echo "Focus For Quarter 3";
                            }else if($type == 'quarter4'){echo "Focus For Quarter 4";}else{ echo ucFirst($type);}
                            ?> Companies</h3> </center>
                            <hr>
                                ...
                                <div class="form-group">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                               <?php $i=1; foreach($cmp as $c){?>
                                               <tr>
                                                   <td><?=$i++?></td>
                                                   <td>
                                                        <a target="_BLANK" href="https://stemapp.in/Menu/AnnualReviewDetails/<?=$c->company_id ?>">
                                                        <?=$this->Menu_model->get_cdbyid($c->company_id)[0]->compname .' - '.$c->company_id?> 
                                                        </a>
                                                    </td>
                                                </tr>
                                               <?php }?>
                            ...
                            <!--<center><a href="<?=base_url();?>Menu/AnnualReviewDet" class="btn btn-success">Self Review</a><br></center>-->
                        <!--</form>           -->
                    </div>
                </div>
            </div>
