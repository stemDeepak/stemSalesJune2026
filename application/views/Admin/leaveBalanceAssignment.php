...
<body>
    <div class="container mt-4">
        <button id="showFormBtn" class="btn btn-primary">Apply for Leave</button>
        
        <div class="form-container" id="leaveFormContainer">
            <h2>User Leave Eligibility Form</h2>
            <form action="/submit_leave_eligibility" method="POST">
                ...
                <!-- Leave input fields for selected leave types can go here -->

                <button type="submit" class="btn btn-success">Submit Leave Eligibility</button>
            </form>
        </div>
    </div>
