...
<html lang="en">
  <head>
    ...
    <title>MoM Writing Pending for RP Meetings | STEM APP | WebAPP</title>
                                  ...
                                  <tbody>
                                    ...
                                    <tr style="background-color: <?php echo $backgroundColor; ?>;color:<?=$backgroundColorNew;?>!important">
                                      ...
                                      ?></td>
                                        ...
                                        <td><a style="color:<?=$backgroundColorNew;?>!important" href="<?= base_url().'Menu/ViewMeetingDetails/'.$dt->task_id ?>">View</td>
