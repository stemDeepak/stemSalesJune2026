    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>My Region Other Project Vs My Project</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $status = $this->Menu_model->get_mrppvsmp($uid);
      foreach ($status as $st) {
        $statusName = "My Project (" . $st->mpcont . ")";
        echo "data.addRow(['$statusName', $st->mpcont, '', '$uid']);";
        $statusName = "Other Project (" . $st->opcont . ")";
        echo "data.addRow(['$statusName', $st->opcont, '', '$uid']);";
      }
      ?>
