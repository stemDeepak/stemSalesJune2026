    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Pending RID Model and Type Wise</h5></center><hr>
...
<div style="width: 80%; margin: auto;">
   <canvas id="combinedChartID1"></canvas>
    ...
    <?php 
        ...
        var combinedData1 = {
            labels: [<?php $bdrmodel = $this->Menu_model->get_bdrmodel($uid); $i=1; foreach($bdrmodel as $bdrm){?> '<?=$bdrm->model_name?>', <?php } ?>],
            datasets: [
                {
                    label: 'RID Model',
                    ...
                    data: [
                        <?php 
                            $bdrmodel = $this->Menu_model->get_bdrmodel($uid); $i=1; foreach($bdrmodel as $bdrm){
                        ?>
                        <?=$bdrm->cont?>,
                        <?php } ?>],
                        stack: 'Stack 0'
                ...
                <?php $rtype = array('replace','Repair');?>
                
                <?php $i=1; for($j=0;$j<=1;$j++){ ?>
                {
                    label: '<?=$rtype[$j]?>',
                    ...
                    data: [
                        <?php 
                        $rt=$rtype[$j];
                        $bdrmodel = $this->Menu_model->get_bdrmodel($uid); foreach($bdrmodel as $bdrm){$rmodel=$bdrm->model_name;
                        $rmodeltype = $this->Menu_model->get_bdrmodelatype($uid,$rmodel,$rt);?>
                        <?=$rmodeltype[0]->cont?>,
                        <?php } ?>
