                        ...
                        <div class="collapse show mt-3" id="collapseExample<?=$k?>">
                          <div class="card card-body" style="background: azure;"  >
                            <div class="ApprovedStatus">
                              ...
                              <div class="table-responsive each">
                                <table id="exampledata" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <th><?= $j ?></th>
                                      <td><?= $this->Menu_model->get_userbyid($todays_data->user_id)[0]->name ?></td>
                                      <td><?= $todays_data->date ?></td>
                                      <td><?= $todays_data->would_you_want ?></td>
                                      <td><?= $todays_data->request_remarks ?></td>
                                    <td>
                                            <?php 
                                                if($todays_data->approvel_status == ''){ ?>
                                                <span class="p-1 bg-warning mr-2">Pending</span>
                                                <?php }else if($todays_data->approvel_status == 'Approved'){ ?>
                                          ...
                                          <td><?=$todays_data->remarks ?></td>
                                              <td>
                                                   ...
                                                   <?php 
						$todays_approvel_status = $todays_data->approvel_status;
						
                                                if($todays_approvel_status == ''){ ?>
                                       
                                        <div>
                                                  <p><a href="<?=base_url();?>Menu/TodaysTaskapprove/<?=$todays_data->nrid ; ?>/Approve" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                                                  <p><button type="button" class="btn btn-primary"  onclick="Reject(<?= $j ?>,<?= $todays_data->nrid ?>,'Reject')">Reject</button></p>
                                                </div>
                                       
                                                <?php }else if($todays_approvel_status == 'Approved'){ ?>
                                                <span class="p-1 bg-success mr-2">Approved</span>
                                                <?php }else{ ?>
                                                <span class="p-1 bg-danger mr-2">Reject</span>
                                                <?php }?>
