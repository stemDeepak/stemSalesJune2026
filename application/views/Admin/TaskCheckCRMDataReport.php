              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
					...
					$task_planneddate 		=$items[0]->task_planneddate;
                                        ?>
                        <table class="table">
                        ...
                        <?php // Display data in a table ?>
                          ...
                          foreach ($items as $item) {    ?>                      
                                  <tr>
                                    ...
                                    <td>
                                      <?php
                                      if($item->question == 'Was Task Planned on time'){
                                        echo $item->question." [".$task_planneddate."]"; 
                                      }
                                      else if($item->question == 'Was Task Initiated on time'){
                                        echo $item->question." [".$initiateddt."]"; 

                                      }
                                      else if($item->question == 'Was Task Updated on time'){
                                        echo $item->question." [".$updateddate."]"; 
                                      }
                                      else{
                                        echo $item->question; 
                                      }  ?></td>
                                    <td><?php echo $item->star;     ?></td>
                                    <td><?php echo $item->late_remarks_message; ?></td>
                                  </tr>
                              <?php
                            $i++;  
                          }
