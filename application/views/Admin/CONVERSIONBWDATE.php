  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Conversion B/W Date</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- /.content-header -->
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/CONVERSIONBWDATE">
    <input type="date" name="sdate" class="mr-2" value="<?=$sd?>">
    <input type="date" name="edate" class="mr-2" value="<?=$ed?>">
    <select name="bdid">
        <option value="0">Same Status</option>
                                ...
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($mdata as $dt){
                                            ...
                                            $tblc=$this->Menu_model->get_tasklogs($ciid,$sdate,$edate,'0');
                                            $logs = sizeof($tblc);
                                            
                                            $olds=$this->Menu_model->get_oldncustatus($bdid,$sdate);
                                            $oldst = $olds[0]->statusid;
                                            $cstt = $olds[0]->cstatusid;
                                            if($oldst){$oldst=$this->Menu_model->get_statusbyid($oldst);$oldst=$oldst[0]->name;}
                                            else{$oldst='';}
                                        ?>
                                        <tr>
                                         <td><?=$i++?></td>
