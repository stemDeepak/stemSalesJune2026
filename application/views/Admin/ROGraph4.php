    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>My Region Other School Vs My School</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $status = $this->Menu_model->get_mrospdvsmspd($uid);
      foreach ($status as $st) {
        $statusName = "My School (" . $st->mscont . ")";
        echo "data.addRow(['$statusName', $st->mscont, '', '$uid']);";
        $statusName = "Other School (" . $st->oscont . ")";
        echo "data.addRow(['$statusName', $st->oscont, '', '$uid']);";
      }
      ?>
