            ...
            <div class="col-12">
                ...
                <?php for($i=0;$i<6;$i++){
                        ...
                        <div class="card p-3">
                            ...
                            <?php
                            $action = $this->Menu_model->get_todaycaction($uid,$dt1,$dt2);
                            foreach($action as $action){?>
                            <div  class="card p-3">
                                <b><?=$action->acname?> (<?=$tt1?> to <?=$tt2?> )</b><hr>
                                <?php 
                                    $aid = $action->aid;
                                    $status = $this->Menu_model->get_todaycstatus($uid,$dt1,$dt2,$aid);
                                    foreach($status as $status){ $stid = $status->stid; ?>
                                        <div  class="card p-3 text-center">
                                            <b><?=$status->stname?> (<?=$tt1?> to <?=$tt2?> )</b><hr>
                                            <div class="row">
                                                <?php $task = $this->Menu_model->get_todayctask($uid,$dt1,$dt2,$aid,$stid); 
                                                ...
                                                <div  class="card p-3 col-2 border border-danger">
                                                    ...
                                                    <b><?=$task->uname?></b><hr>
                                                    <b><?=$tat=$task->appointmentdatetime?></b>
                                                    <b><?=$tint=$task->initiateddt?></b>
                                                    <b><?=$this->Menu_model->timediff($tat,$tint);?></b><hr>
                                                    <b><?=$tint=$task->initiateddt?></b>
                                                    <b><?=$tupt=$task->updateddate?></b>
                                                    <b><?=$this->Menu_model->timediff($tint,$tupt);?></b>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        </div>
