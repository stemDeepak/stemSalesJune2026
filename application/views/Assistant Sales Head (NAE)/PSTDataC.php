                            ...
                            <!-- <th>Change Status</th> -->
                                ...
                                <th>Other</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$date?></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/1"><?=$s?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/9/"><?=$vp?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/6"><?=$p?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/3"><?=$t?></a></td>      
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/5"><?=$n?></a></td>

                                            <!-- <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/22"><?=$c?></a></td> -->

                                            <td><a href="PSTDataCDetail1/<?=$uid?>/<?=$date?>/3/6"><?=$ca?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/8"><?=$cb?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/9"><?=$cc?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/10"><?=$cd?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/11"><?=$ce?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/12"><?=$cf?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/13"><?=$cg?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/14"><?=$ch?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/15"><?=$ci?></a></td>
                                            <td><a href="PSTDataCDetail/<?=$uid?>/<?=$date?>/16"><?=$ot?></a></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
