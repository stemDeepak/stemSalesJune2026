...
class AfterRPMeetingsAssignSameStatus_model extends CI_Model {
    ...
    public function process_AfterRPMeetingsAssignSameStatus_analysis($message, $analysisType, $sdate, $edate) {
        ...
        $sameStatusSinceDaysDatas    = $this->Report_model->GetCompanyAfterLMAssignSameStatusSinceDays($this->uid,$sdate,$edate,$this->uid,'all',$numberofdays);
